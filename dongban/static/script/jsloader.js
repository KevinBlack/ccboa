...
CONTEXT_PATH = location.href.match(/([a-zA-Z:0-9_/\.]*static\/[0-9a-z]+\/).*/)[1] ;
...
if(window.screen.width>1024)
	...
	JSLoader.loadStyleSheet(CONTEXT_PATH+"css/editor.css");
// 如果分辨率大于1024则加载新的css
if(PJF_IS_WIDTH)
...
(function(){
	...
	if(isSafari){
		...
		JSLoader.loadJavaScript(CONTEXT_PATH + 'script/kindeditor-min.js');
	}
	//IE下还是老姿势
	else {
