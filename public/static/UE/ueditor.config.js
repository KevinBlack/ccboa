...
(function () {
    ...
    window.UEDITOR_HOME_URL = "/ecpweb/page/ccboa/static/UE/"
  var URL = window.UEDITOR_HOME_URL || getUEBasePath();
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'link', 'unlink', 'anchor', 
            'scrawl', 'music', 'attachment', 'webapp', 'pagebreak', 'template', 'background', '|',
            'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
        ...
        ,'fontfamily':[
            { label:'',name:'caihongsongti',val:'彩虹粗仿宋,chst'},
            { label:'',name:'caihongheiti',val:'彩虹黑体,chht'},
            { label:'',name:'caihongkaiti',val:'彩虹楷体,chkt'},
            { label:'',name:'caihongxiaobiaosong',val:'彩虹小标宋,chxbs'},
