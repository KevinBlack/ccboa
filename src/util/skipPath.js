...
export function skipPath(row = {}) {
  ...
  let otherRouter = OTHERROUTER[rowObj.DATA_TYPE] || {};
  let otherRouterDone = OTHERROUTERDONE[rowObj.DATA_TYPE] || {};

  let leaveBeijingRouter = LEAVEBEIJINGROUTER[rowObj.DATA_TYPE] || {};
  let leaveBeijingRouterDone = LEAVEBEIJINGROUTERDONE[rowObj.DATA_TYPE] || {};

  let waitReadRouter = WAITREADROUTER[rowObj.DOCUMENT_TYPE] || {};
  let doneReadRouter = DONEREADROUTER[rowObj.DOCUMENT_TYPE] || {};
  return {
    todoDetailRouter,
    doneDetailRouter,
    completeRouter,
...
export function typeNameFormat(row) {
  let nameObj = {
    ...
    "LSZSQ": "临时授权",
    "HBHY_CB": "行长办公会议通知",
    "SEC_YTZ_YTBS": "行长办公会议通知",
    'SEC_YTBS': "提示",
    "SEC_YT_ZBSH": "提示",
    "SEC_BACK_YT": "行长办公会议通知",
    "HBHY_CH": "行长办公会议通知",
    "SEC_ZSTZ": "正式通知",
    "SEC_YTZ_SH": "行长办公会议通知",
    "SEC_BMTZ_SH": "行长办公会议通知",
    "SEC_ZSTZ_SH": "行长办公会议通知",
    "SEC_FK_YTZ": "提示",
    "SEC_FK_BMTZ": "提示",
    //待持续补充。。。
    "柔性团队-任务管理-待办": {
