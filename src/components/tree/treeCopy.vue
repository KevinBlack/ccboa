<template>
  <div class="treeWrap">
    ...
    <el-dialog
      v-dialogDrag
      :title="dialogTit"
      v-if="false&&!loadingTree&&singelCheckF && dialogVisible && !canTab"
      :visible.sync="dialogVisible"
      :close-on-click-modal="false"
      @close="cancelSetDialog"
      width="50%"
          ...
          <div class="tree_w box_shadow">
            <el-scrollbar>
              <el-tree
                ...
                node-key="id"
                :default-expand-all="true"
                :props="dialogType=='dosend'?senddefaultProps:defaultProps"
              >
    ...
    >
      <div v-if="hasRadio">
        <div class="title">
          ...
          <el-radio v-model="sequenceSign" label="1">是</el-radio>
          <el-radio v-model="sequenceSign" label="0">否</el-radio>
        </div>
      </div>
      <el-row>
        <el-col :span="12">
    ...
    <el-dialog
      v-dialogDrag
      :title="dialogTit"
      v-if="!loadingTree&&canTab && dialogVisible"
      :visible.sync="dialogVisible"
      @close="cancelSetDialog"
      width="50%"
    >
...
export default {
  ...
  methods: {
    ...
    getOffenUserInfo(){
      ...
      //   this.getConfigUserInfo(true);//请求后端 查询常用人
      // }else{
        this.getTreeInfo();
      // }
    },
