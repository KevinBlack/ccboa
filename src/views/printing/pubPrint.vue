      ...
      <table cellspacing="0" cellpadding="0" class="printTableList" style="font-family: 宋体;font-size: 19px;" id="print-table">
        <tbody>
          ...
          <tr style="height: 32px;">
            ...
            <td style="padding-left: 10px;text-align:center;vertical-align:middle" colspan="2">{{formdata.drafDepNm}}</td>

            <td style="text-align:center;vertical-align:middle">投稿部门</td>
            <td style="padding-left: 10px;text-align:center;vertical-align:middle">{{formdata.submitDept}}</td>
          </tr>
          <tr style="height: 32px;">
            <td style="width：20%;text-align:center;vertical-align:middle">投稿人</td>
            <td style="width:40%;text-align:center;vertical-align:middle" colspan="2">{{formdata.curUsernm}}</td>
          ...
          <tr style="height: 32px;">
            ...
            <td style="width:40%;text-align:center;vertical-align:middle" colspan="2">{{formdata.title}}</td>
          </tr>

          <tr style="height: 32px;">
            <td style="width：20%;text-align:center;vertical-align:middle">最新评分</td>
            <td style="width:40%;text-align:center;vertical-align:middle" colspan="2">{{formdata.grade}}</td>
            <td style="width:30%;text-align:center;vertical-align:middle">{{formdata.gradeList}}</td>
          </tr>
        </tbody>
      </table>
      <br />
...
export default {
  ...
  created() {
    ...
    this.tableTitle = rowData.title // 报送单标题
