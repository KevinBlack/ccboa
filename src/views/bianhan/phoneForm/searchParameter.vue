    ...
    import apis from '@/httpTansun/api/secreatary/phonenote.js'
      export default {
            ...
            return{
              ...
              pageSize: 20,
               ...
               rules:{
                ...
                tableType:[{required:true,message:'请选择表单类型',trigger:'blur'}]
               },
                tableCols: [
        ...
        methods:{
            //新增
            addNew(){
                this.$router.push({name: 'paramsMaintainAdd', query: {type: 0}})
            },
            selectRow(data) {
                console.log("---选择---", data)
                let len = data.length
            ...
            cellClick(row){
                this.$router.push({name: 'paramsMaintainAdd', query: {rowData: row, type: 1}})
            },
            loadD(){
              const data = {
              id: '',
            ...
            del(){
              ...
              if(!that.selected) {
                ...
                apis.paramsMaintainListDel({id:that.selected}).then(res => {
                    if (res.code==="SUCCESS") {
                      that.$message({
                          type: 'success',
                          message: "删除成功！"
