 ...
 * @LastEditTime: 2021-02-01 15:38:14
...
<template>
  <div class="content">
    ...
    <p class="base-title">秘书成员配置</p>
    <div class="formdata">
      <el-form :rules="rules">
        <el-form-item label="秘书处理人中文名" prop="secCnName">
  ...
  methods: {
    ...
    toSelect() {
      ...
      if (this.btnType === "edit") {
        this.$api.secreatary.leaderActivity.deleteAll({}).then((res) => {});
      }
    },
    ...
    toSave() {
      if (this.formData.secCnName === "") {
        ...
        this.$api.secreatary.leaderActivity
          .saveSectary({
            secCnName: this.arrsecCnNameId.join(","),
          })
          .then((res) => {
            this.$message({
              message: "保存成功",
