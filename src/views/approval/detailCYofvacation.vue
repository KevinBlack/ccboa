...
export default {
  ...
  methods: {
    ...
    viewApply() {
      ...
      this.viewFile(file,true,(this.formData.approveNo ? this.formData.approveNo : this.formData.virtualApproveNo) + this.formData.title);
    },
    //传阅说明关闭
    explainBtn() {
      ...
      switch (params) {
        ...
        case "收藏":
          ...
          type: "warning"
             ...
             this.$api.checkLz
            .handleCollection({ id: this.id, dataType: 0,docType:2 })
            .then(res => {
              this.downFile(res);
            })
          });
