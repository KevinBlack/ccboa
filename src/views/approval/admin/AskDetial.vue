  ...
  <div class="qcDetail" id="shiwuzhifa">
    ...
    <div class="process_content">
      <div class="bank_dispach_content" id="bank_dispach_content">
        ...
        <div class="cur_box">
          <div class="cur_sess">
            ...
            <p>
              是否跨行：
              <span>
                <el-radio-group v-model="formData.isKh" :disabled="isWeiHu">
        ...
        <el-form :rules="rules" :model="formData" label-width="130px">
          <el-row>
            <el-col :span="22">
          ...
          <el-row>
            <el-col :span="7">
              <el-form-item label="姓名" prop="responsiblePerson">
                <el-input v-model="formData.responsiblePerson" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="员工编号" prop="syncHumanCode">
                <el-input placeholder="8位员工编号" v-model="formData.syncHumanCode" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="9">
              <el-form-item label="单位" prop="responsibleUnit">
                <el-input v-model="formData.responsibleUnit" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
              <el-form-item label="出发日期" prop="departDate">
                <el-date-picker
                  ...
                  placeholder="选择出发日期"
                ></el-date-picker>
                <el-select v-model="formData.departTiming" :disabled="isWeiHu" placeholder="请选择">
                  <el-option
            ...
            <el-col :span="11">
              <el-form-item label="返回日期" prop="backDate">
                <el-date-picker
                  ...
                  placeholder="选择出发日期"
                ></el-date-picker>
                <el-select v-model="formData.backTiming" :disabled="isWeiHu" placeholder="请选择">
                  <el-option
                    v-for="item in timeLists"
                    :key="item.val"
                    :label="item.label"
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="请假" prop="record">
                <el-checkbox-group :disabled="isWeiHu" v-model="formData.leavesType">
                  <el-checkbox
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="备案" prop="record">
                <el-checkbox-group :disabled="isWeiHu" v-model="formData.recordsType">
                  <el-checkbox
          ...
          <el-row>
            <el-form-item label="前置审批依据">
              <el-col :span="20">
                <el-input
                  v-model="formData.beforeLeadInfo"
                  :disabled="isWeiHu"
                  placeholder="可引入依据或手工填写依据"
                ></el-input>
              </el-col>
              <el-col :span="2">
                <el-button
              ...
              <div v-for="item in YRcheck" :key="item.id">
                ...
                <el-button @click="importDle(item)" size="mini" type="danger" :disabled="isWeiHu">删除</el-button>
              </div>
            </el-form-item>
          </el-row>
          <el-row :gutter="6" v-if="formData.beforeHoliday == '1'">
            <el-form-item label="休假前置审批依据" prop="leaveBase">
              <el-col :span="20">
                <el-input
                  :disabled="isWeiHu"
                  readonly
                  v-model="formData.leaveBases"
                  placeholder="请引入依据"
                ></el-input>
              </el-col>
              <el-col :span="2">
          ...
          <el-row :gutter="6" v-if="formData.goAbroad == '1'">
            <el-form-item label="因私出境审批依据" prop="leaveCountryBase">
              <el-col :span="20">
                <el-input
                  :disabled="isWeiHu"
                  readonly
                  v-model="formData.leaveCountryBases"
                  placeholder="请引入依据"
                ></el-input>
              </el-col>
              <el-col :span="2">
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item :label="'请假、备案期间\n联系方式'" prop="otherTel">
                <el-input v-model="formData.otherTel" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
              <el-form-item :label="'主持工作\n人员姓名'" prop="directPerson">
                <el-input v-model="formData.directPerson" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item :label="'主持工作\n人员职务'" prop="directPostion">
                <el-input v-model="formData.directPostion" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="22">
              <el-form-item label="事由报告" prop="reason">
                <el-input
                  type="textarea"
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="报送人" prop="contactName">
                <el-input v-model="formData.contactName" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="申请部门" prop="draftDepartment">
                <el-input v-model="formData.draftDepartment" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
              <el-form-item label="座机号码" prop="specealPlane">
                <el-input v-model="formData.specealPlane" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="手机号码" prop="phoneNum">
                <el-input v-model="formData.phoneNum" :disabled="isWeiHu"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <!-- 销假情况 -->
          <el-form-item label="销假情况" v-if="formData.backLeaveInfo == '1'">
            <el-button
              type="primary"
              @click="addSucc('backLeaveOpinionList')"
              :disabled="isWeiHu"
            >新增意见</el-button>
            <div class="suggStyle">
              <div
                v-bind:class="['d_flex',{'border_line':index!=(formData.backLeaveOpinionList.length-1)}]"
                v-for="(item,index) in formData.backLeaveOpinionList"
                :key="index"
                style="margin-bottom:26px"
              >
                <el-row class="d_b100">
                  <el-col :span="24">
                    ...
                    <el-col :span="2" style="margin-left:12px">
                      <el-button
                        type="danger"
                        @click="deleSugg('backLeaveOpinionList',index,item.id)"
                        :disabled="isWeiHu"
                      >删除</el-button>
                    </el-col>
                  </el-col>
          ...
          <el-form-item label="传阅意见">
            <!-- <el-button type="primary" @click="addSucc('cyOpinionList')" :disabled="true">新增意见</el-button> -->
            <div class="suggStyle">
              <div
                v-bind:class="['d_flex',{'border_line':index!=(formData.cyOpinionList.length-1)}]"
                v-for="(item,index) in formData.cyOpinionList"
                :key="index"
                style="margin-bottom:26px"
              >
                <el-row class="d_b100">
                  <el-col :span="24">
                    ...
                    <el-col :span="2" style="margin-left:12px">
                      <el-button
                        type="danger"
                        @click="deleSugg('cyOpinionList',index,item.id)"
                        :disabled="true"
                      >删除</el-button>
                    </el-col>
                  </el-col>
          ...
          <el-row style="margin-left:120px" v-if="(formData.isKh==0)&&!isWeiHu">
            <el-col :span="22">
              <upload-file-ts :uploadConfig="uploadConfig" @fileList="fileList"></upload-file-ts>
            </el-col>
          </el-row>
          <!--     跨行时附件域分     -->
          <el-row style="margin-left:120px" v-if="(formData.isKh==1)&&!isWeiHu">
            <el-col :span="22">
              <upload-file-ts :uploadConfig="uploadConfig" @fileList="fileList"></upload-file-ts>
            </el-col>
          </el-row>
      ...
      <div style="margin-top:4px">
        <el-form :model="YRDeal" label-width="160px">
          <el-form-item label="文号" style="width:80%;margin-top:16px;">
            <el-input v-model="YRDeal.orderNo" :disabled="isWeiHu"></el-input>
          </el-form-item>
  ...
  data() {
    return {
      ...
      buttonList: [
        ...
        { name: "查看流程", show: true },
        { name: "打印申请表", show: true },
        { name: "打印处理单", show: true },
        { name: "收藏", show: true },
        { name: "维护", show: true },
        { name: "流程调度", show: false }
        // { name: "归档", show: false }
  ...
  methods: {
    ...
    deleMark(n, dataId) {
      this.$confirm("是否确定删除当前数据?", "提示", {
        ...
        .then(() => {
          if (dataId) {
            this.$api.checkLz.delAskDetail({ id: dataId }).then(res => {
              if (res.code == "SUCCESS") {
                this.formData.mark = "";
                this.$message({
                  message: "操作成功",
    ...
    deleSugg(sugg, n, dataId) {
      this.$confirm("是否确定删除当前数据?", "提示", {
        ...
        .then(() => {
          if (dataId) {
            this.$api.checkLz.delAskMsg({ id: dataId }).then(res => {
              if (res.code == "SUCCESS") {
                this.formData.mark = "";
                this.$message({
                  message: "操作成功",
            ...
            switch (sugg) {
              ...
              case (sugg = "blqkOpinionList"):
                ...
                break;
              case (sugg = "backLeaveOpinionList"):
                this.formData.backLeaveOpinionList.splice(n, 1);
                break;
    ...
    addSucc(range) {
      ...
      console.log(AcreateTime);

      switch (range) {
        case (range = "backLeaveOpinionList"):
          this.formData.backLeaveOpinionList.push({
            content: "",
    ...
    saveData() {
      ...
      if(!this.formData.backLeaveOpinionList) {
        this.formData.backLeaveOpinionList = []
      }
      ...
      this.$api.checkLz
        .addAskDetail({ ...this.formData, adminType: "admin" })
        .then(res => {
          if (res.code == "SUCCESS") {
            this.formData.mark = "";
            this.$message({
