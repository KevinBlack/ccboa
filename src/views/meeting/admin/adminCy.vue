<!--
 * @Author: your name
 * @Date: 2020-08-03 14:55:57
 * @LastEditTime: 2021-08-30 11:25:06
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \OA\src\views\meeting\admin\adminCy.vue
--> 
...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.formData.sortKey = "sendDate";
    },
    loadData(type) {
      if (!type) {
        this.pagination.pageNum = 1;
      }
      this.formData.sutType = this.sonselect;
      this.$api.meeting
        .adminCYTable(this.formData, {
