  ...
  methods: {
    getNumYearList() {
      return new Promise((resolve, reject) => {
        this.$api.numYear.getNumYearList({tbParam:'bmyyAdmin'}).then(res => {
    ...
    deleteForms() {
      ...
      this.$confirm(
        ...
        this.$api.sealManage.delDepartment({ ids: this.selectIds }).then(res => {
          if (res.code == "SUCCESS") {
            this.deleteArry = "";
    ...
    loadData() {
      ...
      this.formList.processType = this.processType;
      this.$api.sealManage
        .departmentDetailList(this.formList, {
