...
' @LastEditTime: 2020-12-23 16:38:01
    ...
    data(){
        return {
            ...
            tableCols: [
                ...
                { label: '申请单位', prop: 'sdept' },
                { label: '文号', prop: 'documentNo' },
                { label: '标题', prop: 'title' },
                { label: '用印数量', prop: 'markNum' },
    ...
    methods: {
       ...
       selectOrg (org) {
        ...
        loadData(){
            ...
            this.$api.managementDetail.documentDetailList(params,{
