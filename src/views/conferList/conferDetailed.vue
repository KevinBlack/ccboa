    ...
    >
      <el-form ref="elForm" :rules="rules" :model="formData" label-width="120px">
        ...
        <el-form-item label="主持人" prop="zcName">
          ...
          <el-button class="right" @click="selectZcPerson" disabled type="primary" size="large">选择</el-button>
        </el-form-item>
        <!-- 出席 -->
        ...
        <el-row :span="24" style="margin-bottom:20px">
          <div style="float:right;">
            ...
            >添加</el-button>
            <el-button class="right" type="primary" size="medium" disabled @click="delBank">删除</el-button>
          </div>
        </el-row>
                  ...
                  <el-row :span="24" type="flex" justify="space-between">
                    <el-col :span="10">
                      <el-row type="flex" justify="space-around">
                        ...
                        <el-col :span="19">
                          <el-input v-model="item.GgName" disabled class="input-with-select">
                            <el-button
                              slot="append"
        ...
        <el-form-item>
          <div class="right">
            ...
            <el-button type="primary" size="mini" plain @click="create_new" disabled>新增议题</el-button>
            <el-button type="primary" size="mini" plain @click="adviseUpMove" disabled>上移</el-button>
            <el-button type="primary" size="mini" plain @click="adviseDownMove" disabled>下移</el-button>
            <el-button type="primary" size="mini" plain @click="adviseDel" disabled>删除</el-button>
            <el-button type="primary" size="mini" plain @click="adviseProcess">查看参会部门流程</el-button>
            <el-button type="primary" size="mini" plain @click="back" disabled>退回</el-button>
        ...
        <el-form-item label="报名信息">
          <div style="height:40px">
            <div class="right">
              <el-button size="mini" type="primary" @click="saveBm" disabled>保存</el-button>
              <el-button size="mini" type="primary" @click="editBm" disabled>编辑</el-button>
