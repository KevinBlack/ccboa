    ...
    <div class="process_content" id="bank_dispach_content">
      ...
      <el-form ref="elForm" :rules="rules" :model="formData" label-width="120px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="拟稿日期" prop="draftDate" disabled>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="会议名称" prop="tzName">
              <el-input v-model="formData.tzName" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="会议时间" prop="hyTime">
              <!-- <el-date-picker
                  ...
                  :style="{width:'100%'}"
              ></el-date-picker>-->
              <el-input v-model="formData.hyTime" :style="{width:'100%'}" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="会议地点" prop="hyAdress">
              <el-input v-model="formData.hyAdress" :style="{width:'100%'}" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="会议候场地点" prop="hyHcdd">
              <el-input v-model="formData.hyHcdd" :style="{width:'100%'}" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
