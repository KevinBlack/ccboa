        ...
        <el-col :span="20">
          <el-form>
            <el-form-item label-width="140px" label = "附件" >
              <upload-file-ts :uploadConfig="uploadConfig" @fileList="fileList" v-show = " !id || !isSave"></upload-file-ts>
                        ...
                        >
                          <template>
                            <div class="command_file">
                              ...
                              <span class="name down" @click="viewFile(item,null,item.title)">{{item.fileName}}</span>
