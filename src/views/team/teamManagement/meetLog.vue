<template>
  <div>
    ...
    <header class="bank_dispach_header">
      <h3 class="bank_dispach_tit">会议纪要</h3>
    </header>
    <el-form
      :model="formData"
      ref="ruleForm"
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item label="所属团队" prop="teamname" ref="teamname">
            <el-select disabled v-model="formData.teamname" clearable placeholder="请选择团队">
      ...
      <el-form-item label="会议详情">
        ...
        disabled
          type="textarea"
          placeholder="请输入内容,最多600个文字"
          v-model="formData.meetingDetails"
          maxlength="600"
        ></el-input>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      fileList: [],
      value: false,
      taskmeetingsummary_getDetails_parmas:{
  ...
  created() {
    this.taskmeetingsummary_getDetails_parmas.id = this.$route.query.id ? this.$route.query.id : "";
    this.getInitData()
  },
  mixins: [viewDraft],
   methods: {
    ...
    getInitData() {
      this.$post
        .postData(
          ...
          JSON.stringify(this.taskmeetingsummary_getDetails_parmas),
