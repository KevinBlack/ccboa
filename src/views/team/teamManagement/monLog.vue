<template>
  <div>
    ...
    <header class="bank_dispach_header">
      <h3 class="bank_dispach_tit">月报</h3>
    </header>
    <el-form
      :model="formData"
      ref="ruleForm"
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="开始时间">
            <el-input disabled v-model="formData.startTime"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="结束时间">
            <el-input disabled v-model="formData.endTime"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="本月工作内容">
        <el-input
          disabled
          type="textarea"
          placeholder="请输入内容,最多600个文字"
          v-model="formData.thisMonthWork"
          maxlength="600"
        ></el-input>
      </el-form-item>
      <el-form-item label="本月工作总结">
        <el-input
        disabled
          type="textarea"
          placeholder="请输入内容,最多600个文字"
          v-model="formData.thisMonthSummary"
          maxlength="600"
        ></el-input>
      </el-form-item>
      <el-form-item label="下月工作计划">
        ...
        disabled
          type="textarea"
          placeholder="请输入内容,最多600个文字"
          v-model="formData.nextMonthWork"
          maxlength="600"
        ></el-input>
      </el-form-item>
      <el-form-item label="帮助与支持">
        <el-input
        disabled
          type="textarea"
          placeholder="请输入内容,最多600个文字"
          v-model="formData.helpSupport"
          maxlength="600"
        ></el-input>
      </el-form-item>
...
export default {
  ...
  created() {
    this.taskMonthly_getDetails_parmas.id = this.$route.query.id ? this.$route.query.id : "";
    this.getInitData()
  },
  mixins: [viewDraft],
  methods: {
    ...
    //初始化数据
      ...
      this.$post
        .postData(
          ...
          JSON.stringify(this.taskMonthly_getDetails_parmas),
