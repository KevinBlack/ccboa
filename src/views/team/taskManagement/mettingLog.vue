      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="会议地点" prop="meetingPlace">
            <el-input :disabled="!formData.edit" type="text" placeholder="请输入内容,最多50个文字" v-model="formData.meetingPlace"></el-input>
          </el-form-item>
        </el-col>
      </el-row>

      <el-form-item label="参会人" prop="attendee">
        <el-input :disabled="!formData.edit" type="textarea" placeholder="请输入内容,最多600个文字" v-model="formData.attendee"></el-input>
      </el-form-item>
      <el-form-item label="会议主题" prop="meetingTheme">
        <el-input :disabled="!formData.edit" type="textarea" placeholder="请输入内容,最多600个文字" v-model="formData.meetingTheme"></el-input>
      </el-form-item>
      <el-form-item label="会议详情" prop="meetingDetails">
        <el-input :disabled="!formData.edit" type="textarea" placeholder="请输入内容,最多600个文字" v-model="formData.meetingDetails"></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      bank_meetinfo: {
        function: "taskmeetingsummary_getDetails",
        id: ""
      },
      bank_save: {
        function: "taskmeetingsummary_save",
        teamid: "",
        teamname: ""
      },
      share_parmas: {
  ...
  created() {
    this.bank_meetinfo.id = this.$route.query.id ? this.$route.query.id : "";
    ...
    this.getSelectData();
    if (this.bank_meetinfo.id != "") {
      this.uploadConfig.id = this.bank_meetinfo.id;
      this.uploadImgConfig.id = this.bank_meetinfo.id;
  ...
  methods: {
    ...
    getInitData() {
      this.$post
        .postData(
          "taskmeetingsummary_getDetails",
          JSON.stringify(this.bank_meetinfo),
            ...
            .then(res => {
              if (res && res.success) {
                ...
                if (type === "uploadfile") {
                  ...
                  this.bank_meetinfo.id = res.data.id;
                  this.isPreserve = true;  
                  if(fileTypeNow == 2){
