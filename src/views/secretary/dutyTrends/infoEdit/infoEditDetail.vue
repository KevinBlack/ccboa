 ...
 * @LastEditTime: 2020-11-25 10:52:40
  ...
  <div class="zfTwo">
    <div class="headerClick">
      <div class="left" @click="closeWindow">
        <i class="el-icon-arrow-left"></i>备选稿件</div>
      <div class="right">
        <el-button plain class="bank_grid_comtent_active" @click="closeWindow">关闭</el-button>
        <!-- <el-button plain class="bank_grid_comtent_active" @click="dialogFormVisible = true">发错情通知</el-button> -->
    ...
    <div class="formHeader">
      <div class="title-text">{{formData.submitUnit+"报送来稿单"}}</div>
    </div>
    <div class="process_content" id="bank_dispach_content">
      ...
      <el-form ref="ruleForm" :model="formData" label-width="120px">
        ...
        <el-form-item label="内容">
          <el-input type="textarea" v-model="formData.content" :disabled="isEdit"></el-input>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog title="错情说明" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="错情说明" :label-width="formLabelWidth">
          <el-input type="textarea" placeholder="请填写错情说明" v-model="formData.remark" :disabled="isEdit"></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    getCheckboxList() {
      this.$api.duty.checkboxData({ data: {} }).then((res) => {
        ...
        console.log(this.otherBankName,"this.otherBankName")
    ...
    printForm() {
      ...
      this.$router.push({
        ...
        query: {        
          ...
          sourceRouteName: 'mamuscriptInfoEditDetail',
    ...
    loadData() {
      ...
      this.formData = this.dataFromQuery('detail1')
      this.formData.activityType = this.formData.activityType.split(',')
      this.otherBankId = this.formData.activityType && this.formData.activityType
