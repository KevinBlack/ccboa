      ...
      <div class="bank_dispach_file">
        <div class="bank_dispach_file_part">
          ...
          >
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="是否办结" prop="isEnd" disabled="true">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="收文时间">
                  <el-input v-model="formData.receiveTime" disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="文号">
                  <el-input v-model="formData.documentCode" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="来文单位">
                  <el-input v-model="formData.sendOrgName" disabled="true"></el-input>
                  <!-- sendOrgName -->
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="紧急程度">
                  <el-input v-model="formData.emergencyName" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="主题词">
                  <el-input v-model="formData.topic" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item label="承办部门">
                  <el-row>
                    <el-col :span="10">
                      <el-input v-model="formData.undertakeDeptName" disabled="true"></el-input>
                    </el-col>
                    <el-col :span="2">
                      <el-button
                        type="btn"
                    ...
                    <el-col :span="10">
                      <el-form-item label="归档部门" prop="archiveDeptName">
                        <el-input v-model="formData.archiveDeptName" disabled="true"></el-input>
                      </el-form-item>
                    </el-col>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="督办时间">
                  <el-input v-model="formData.superviseDate" disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="办理期限">
                  <el-input v-model="formData.limitDate" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="办理状态">
                  <el-input style="width:100%" v-model="formData.progress" disabled="true">
              ...
              <el-col :span="12">
                <el-form-item label="办结时间">
                  <el-input v-model="formData. undertakeEndTime" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="发送协办时间">
                  <el-input v-model="formData.xbStartTime" disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="结束协办时间">
                  <el-input v-model="formData.xbEndTime" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="催办信息">
                  <el-input v-model="formData.cbRecord" disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="催办次数">
                  <el-input v-model="formData.cbCount" disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="首次催办信息" disabled="true">
                  <el-input v-model="formData.cbFirstTime"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="末次催办时间" disabled="true">
                ...
                <el-row>
                  <el-col>
                    <el-table :data="lcData" border ref="multipleTable" style="width: 100%">
                      ...
                      <el-table-column prop="nodeName" label="处理环节" align="center" width="408"></el-table-column>
                      <el-table-column prop="completeTime" label="操作时间" align="center" width="408"></el-table-column>
                      <el-table-column prop="operatorName" label="处理人" align="center" width="408"></el-table-column>
                      <el-table-column prop="operation" label="处理记录" align="center" width="412"></el-table-column>
                    </el-table>
                  </el-col>
                </el-row>
              </div>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <el-form-item label="协办次数">
                    <el-input v-model="formData.xbCount" disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="协办反馈用时">
                    <el-input v-model="formData.xbDisposeDuration" disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="处理工作日">
                    <el-input v-model="formData.disposeDuration" disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="主办部门处理用时">
                    <el-input v-model="formData.undertakeDisposeDuration" disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="主办部门处理用时占比">
                    <el-input v-model="formData.zbDeptRate" disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <div>
...
export default {
  ...
  data() {
    return {
      ...
      receiveselect: {
        function: "selectSuperviseYwById",
        id: ""
      },
      saveOrUpdateSW: {
      ...
      formData: {
        ...
        undertakeDisposeDuration: "", // 主办部门处理用时
  ...
  methods: {
    ...
    savedata() {
      ...
      //   this.ruleForm.draftRange = this.ruleForm.setDraftRange
      this.$api.adminConfig.alterWin(this.ruleForm).then(res => {
    ...
    // shoucang() {
    //   let that = this;
    //   let shiwutitle = this.formData.documentCode; //字号
    //   let draftInfo = this.formData.filePath
    //     ? [].concat(
    //         {
    ...
    //       JSON.stringify({
    //         function: "doWithdrawTask",
    //         pcsAvyId: this.formData.pcsAvyId,
    ...
    this.$post
      ...
      .then(res => {
        if (res && res.success) {
          ...
          //this.selectType((this.formData.secretType = "商业秘密"));
