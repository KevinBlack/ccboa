  ...
  <div class="add">
    ...
    <div class="elementForm">
      <el-form ref="addForm" :rules="rules" :model="formData" label-width="160px">
        <el-form-item label="机构名称" prop="activityCategory">
        ...
        <el-form-item label="截止时间" prop="blockingTime">
          <el-date-picker v-model="formData.blockingTime" type="date" placeholder="截止时间" :disabled="isColumTypeDisabled"></el-date-picker>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      btnType: '',
      rules: {
        timeOverAlertInfo: [{ required: true, message: '请输入超时提示内容', trigger: 'blur' }],
        blockingTime: [{ required: true, message: '请选择截止时间', trigger: 'blur' }],
      },
      seletOptionsData: [],
      offenUse: true,
      checkIds: [], //选中id列表
