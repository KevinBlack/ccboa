    ...
    <div class="elementForm">
      <el-form ref="addForm" :rules="rules" :model="formData" label-width="160px">
        <el-form-item label="活动类别" prop="activityCategory">
          <el-input v-model="formData.activityCategory" maxlength="80" :disabled="isColumTypeDisabled"></el-input>
        </el-form-item>
        <el-form-item label="内容格式示例" prop="contentExample">
          <el-input v-model="formData.contentExample" :disabled="isColumTypeDisabled"></el-input>
        </el-form-item>
        <el-form-item label="关键字" prop="keywords">
          <el-input v-model="formData.keywords" :disabled="isColumTypeDisabled"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        contentExample: [{ required: true, message: '请输入内容格式示例', trigger: 'blur' }],
      },
    }
  },
