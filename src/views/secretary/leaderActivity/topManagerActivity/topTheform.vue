  ...
  <div class="topTheform">
    <div class="common-header">
      <div class="headerClick">
        ...
        <el-button @click="closeData('加至领导资料库')" class="bank_grid_comtent_active">加至领导资料库</el-button>
        <el-button
          v-if="LookId"
    ...
    <div class="formHeader">
      <div class="shiwuTitle">本周高管成员活动安排表单</div>
      <div class="content">
        ...
        >
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="开始日期" prop="userTime">
                <el-date-picker
            ...
            <el-col :span="8">
              <el-form-item label="开始时间" prop="isFsdDoc" >
                <el-time-select
            ...
            <el-col :span="6">
              <el-form-item label="结束时间" prop="isFsdDoc" >
                <el-time-select
