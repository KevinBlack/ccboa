/**
* create by zx on 2021/2/20 10:50
* 类注释：
* 备注：高管我的日程
*/
<template>
  <div class="topmyActivity">
    ...
    <div v-else>
      ...
      <el-table :data="tableData" border style="width: 100%" id="table" @cell-dblclick="btn">
...
export default {
  ...
  data() {
    return {
      day: new Date(),
      calendarData: [],
      buttonList: ["上一周", "本周", "下一周", "打印", "全部日程", "活动安排","新建活动"],
      dayHourText: [
        "8AM",
        "9AM",
        "10AM",
