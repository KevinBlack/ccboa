  ...
  <div class="secretaryWorkArrange">
    ...
    <div class="message">
      <div style="display: flex">
        ...
        <el-button v-for="(item,index) in buttonList" type="primary" @click="buttonClick(item)" :key="index"
          size="mini">{{item}}</el-button>
      </div>
      <el-table :data="tableData" border style="width: 100%;margin-top:20px;" id="table" @row-click="openDetails">
