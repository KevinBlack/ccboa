...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: "日期时间", prop: "startDate" },
        { label: "地点", prop: "activeAddress" },
        { label: "主持行领导", prop: "currentLeaderEn" }
      ],
      pagination: {
        pageNum: 1,
        pageSize: 20,
  ...
  methods: {
    ...
    rest() {
      (this.form.title = ""), //标题
        (this.form.startDate = ""), //开始日期
        (this.form.startTime = ""), //开始时间
        (this.form.endTime = ""), //结束时间
        (this.form.activeAddress = ""), //活动地址
        (this.form.activeType = ""), //活动类型
        (this.form.attendBankLeader = ""); //行领导
    },
    Export() {
