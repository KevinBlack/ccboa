<template>
  <div>
    <div id="printHtml" class="tablePrint">
      <el-row>
        <h1 style class="title-h1">{{unitName}}党委成员活动安排处理单</h1>
      ...
      >
        <tbody>
          ...
          <tr>
            <td style="text-align:center;vertical-align:middle">行领导</td>
            <td colspan="10" style="padding-left: 10px;text-align:center;vertical-align:middle">{{hname}}</td>
          </tr>
          <tr style="height: 32px;">
            <td style="width：20%;text-align:center;vertical-align:middle">同时添加至</td>
            <td
              colspan="4"
