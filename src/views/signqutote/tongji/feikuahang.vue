        ...
        <table class="stcs_table">
          <tr>
            <td>
              ...
              <br />（1）统计范围：根据非跨行签报处理单类型统计电子、实物签报的数量及办结情况。
              <br />（2）小计：各类型签报电子、实物签报的总数。
              <br />（3）办结数：各类型签报的办结数。
              <br />（4）办结率=办结数/小计数*100%。
              <br />（5）总办结数=各类型签报办结数之和。
              <br />（6）总办结率=各类型签报办结数之和/合计（列）*100%。
            </td>
          </tr>
        </table>
      </el-col>
...
const finshData = [
  { label: "部门名称", prop: "bumen", align: "center"  ,width:"250"},
  { label: "电子行签报", prop: "hdz", align: "center" },
  { label: "实物行签报", prop: "hsw", align: "center" },
  { label: "小计", prop: "hzs", align: "center" },
  { label: "办结数", prop: "hbjs", align: "center" },
  { label: "电子部间签报", prop: "bjdz", align: "center" },
  { label: "实物部间签报", prop: "bjsw", align: "center" },
  { label: "小计", prop: "bjzs", align: "center" },
  { label: "办结数", prop: "bjbjs", align: "center" },
  { label: "电子部内签报", prop: "bndz", align: "center" },
  { label: "实物部内签报", prop: "bnsw", align: "center" },
  { label: "小计", prop: "bnzs", align: "center" },
  { label: "办结数", prop: "bnbjs", align: "center" },
  { label: "合计", prop: "heji", align: "center" },
  { label: "总办件数", prop: "zbjs", align: "center" },
  { label: "总办结率", prop: "zbjl", align: "center" }
];
export default {
  // 协办情况
  ...
  data() {
    return {
      bank_countersignature: {
        function: "queryTJQianbaoNotKuaHang",
        page: 1, //当前页数
        limit: 20, //每页条数
        total:0,
        draftTimeStart:"",
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.bank_countersignature.function = "queryTJQianbaoNotKuaHang";
      this.bank_countersignature.draftTimeStart = "";
      this.bank_countersignature.draftTimeEnd = "";
      this.bank_countersignature.page = this.pagination.page = 1;
    ...
    exportData(){
      exportTable.exportExcel("非跨行签报按类型统计表");
    }
  },
  created() {
