...
const finshData = [
  { label: "部门", prop: "tuiHuiName", align: "center" },
  { label: "签报退文次数", prop: "tuiHuiCount", align: "center" },
  { label: "签报总数", prop: "zsCount", align: "center" }
];
export default {
  // 协办情况
  ...
  data() {
    return {
      bank_countersignature: {
        function: "queryTJQianbaoBackKuaHang",
        page: 1, //当前页数
        limit: 20, //每页条数
        total:0,
        draftTimeStart:"",
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.bank_countersignature.function = "queryTJQianbaoBackKuaHang";
      this.bank_countersignature.draftTimeStart = "";
      this.bank_countersignature.draftTimeEnd = "";
      this.bank_countersignature.page = this.pagination.page = 1;
     ...
     exportData(){
      exportTable.exportExcel("签报在流转过程中被退回情况统计表");
    }
  },
  created() {
