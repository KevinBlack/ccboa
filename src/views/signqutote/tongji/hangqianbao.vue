      ...
      <el-col>
        ...
        >
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="行签报类别">
                <el-radio-group v-model="bank_countersignature.qblb" >
                  <el-radio label="">全部</el-radio>
                  <el-radio label="请示">请示</el-radio>
                  <el-radio label="报告">报告</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="8">
...
const finshData = [
  ...
  { label: "1000字以下件数", prop: "xyCount", align: "center" },
  { label: "1001-2000字件数", prop: "qjCount1", align: "center" },
  { label: "2001-3000字件数", prop: "qjCount2", align: "center" },
  { label: "3001-5000字件数", prop: "qjCount3", align: "center" },
  { label: "总件数", prop: "zjs", align: "center" },
  { label: "平均字数", prop: "pjzs", align: "center" }
];
export default {
  components: {
    mTable,
  ...
  data() {
    return {
      bank_countersignature: {
        function: "queryTJQianbaoCountByType",
        page: 1, //当前页数
        limit: 20, //每页条数
        total:0,
        draftTimeStart:"",
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.bank_countersignature.function = "queryTJQianbaoCountByType";
      this.bank_countersignature.draftTimeStart = "";
      this.bank_countersignature.draftTimeEnd = "";
    ...
    exportData(){
      exportTable.exportExcel("行签报（“行签报类型”）字数统计表");
    }
  },
  created() {
