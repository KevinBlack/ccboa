        ...
        <table class="stcs_table">
          <tr>
            <td>
              ...
              <br />（3）在办件数：收到协办单时间在统计时间段内协办状态为“正在协办”的文档数。
              <br />（4）办结件数：收到协办单时间在统计时间段内协办状态为“协办完毕”的文档数。
              <br />（5）平均协办办理时长=每份文件协办办理时长之和/协办件数。
              <br />（6）最长协办办理时长：各份文件协办办理时长中的最大值。
            </td>
...
const finshData = [
  { label: "协办部门", prop: "bumen", align: "center" },
  { label: "协办件数", prop: "zs", align: "center" },
  { label: "在办件数", prop: "wbjCount", align: "center" },
  { label: "办结件数", prop: "ybjCount", align: "center" },
  { label: "平均协办办理时长", prop: "pj", align: "center" },
  { label: "最长协办办理时长", prop: "zd", align: "center" }
];
export default {
  // 协办情况
  components: {
  ...
  methods: {
    ...
    resetForm(formName) {
      ...
      this.bank_countersignature.function = "queryTJQianbaoXieban";
      this.bank_countersignature.draftTimeStart = "";
      this.bank_countersignature.draftTimeEnd = "";
      this.bank_countersignature.page = this.pagination.page = 1;
     ...
     exportData(){
      exportTable.exportExcel("跨行签报协办办理时间统计表");
    }
  },
  created() {
