      ...
      <el-col>
        ...
        >
          ...
          <div v-if="down">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="领导姓名" prop="userName">
                  <el-input v-model="bank_countersignature.userName"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
const finshData = [
  { label: "成交日期", prop: "createTime", align: "center" },
  { label: "文号", prop: "documentNo", align: "center" },
  { label: "标题", prop: "title", align: "center" },
  { label: "领导姓名", prop: "userName", align: "center" },
  { label: "批示意见", prop: "content", align: "center" },
...
export default {
  ...
  methods: {
    exportExc(){
      exportTable.exportExcel("领导批示查询表",".el-table");
    },
    initData() {
      this.$router.push({
        query: {
    ...
    handleOpenPage(path, id ,nodeCode,readType) {
    ...
    cellClick(row, column, cell, event) {
      ...
      this.nodeCode = row.nodeCode ? row.nodeCode : "";
      
      this.handleOpenPage("/lingdaoPishiDetails", this.idType,this.nodeCode);
    ...
    resetForm(formName) {
      ...
      this.bank_countersignature.function = "queryQianbaoOpinion";
      this.bank_countersignature.createTimeStart = "";
      this.bank_countersignature.createTimeEnd = "";
      ...
      this.bank_countersignature.userName = "";
