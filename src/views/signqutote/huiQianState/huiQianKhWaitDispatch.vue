<template>
  <!-- 中国建设银行电子签报会签意见单
    非跨行  跨行请示行
  -->
  <div id="signquteWaitKhHq" class="bank_dispach">
    <el-row>
            ...
            <el-row class="pr45">
              ...
              <el-col>
                <el-form-item label="上级单位办理情况">
                  ...
                  <el-input
                    ...
                    disabled
                    v-if="!editedIdeaFields.agreementHandleSituation  || (editedIdeaFields.agreementHandleSituation && !(fromdata.agreementHandleSituationList && fromdata.agreementHandleSituationList.length))"
                  ></el-input>
                  <opinionText
                              ...
                              >
                                <template>
                                  <div class="command_file">
                                    ...
                                    <span class="down" @click="downFile(items)">{{items.fileName}}</span>
                                    <span
                                      class="name"
              ...
              <el-col>
                <el-form-item label="核稿意见">
                  ...
                  <el-input
                    ...
                    disabled
                    v-if="!editedIdeaFields.hegaoOpinion  || (editedIdeaFields.hegaoOpinion && !(fromdata.hegaoOpinionList && fromdata.hegaoOpinionList.length))"
                  ></el-input>
                  <opinionText
              ...
              <el-col>
                <el-form-item label="会签过程意见">
                  ...
                  <div class="fix_height" v-if="fromdata.isMutil != 1">
                    <el-input
                      type="textarea"
                      maxlength="500"
                      resize="none"
...
export default {
  ...
  data() {
    return {
      ...
      buttonList: [
        ...
        { name: "选择会签人", type: "btn_xzhqr", show: false }, //都有
  ...
  methods: {
    ...
    sendTackHandle() {
      ...
      // agreementOpinionList  agreementHandleSituationList  upAttchmentFileInfo
      // consultOpinionList  hegaoOpinionList  signOpinionList  draftDepartmentOpinionList
      // handleSituationList  circulationList  remarkList   mainDeptAttachment
    ...
    doBacksyclrHandle() {
      ...
      var obj = Object.assign(
        { function: "returnBeforeHuman", tplbsnid: "KHQB_HQ" },
        parseList
      );
    ...
    shoucang() {
      ...
      if (
        ...
        this.fromdata.consultAttachment.length
      ) {
