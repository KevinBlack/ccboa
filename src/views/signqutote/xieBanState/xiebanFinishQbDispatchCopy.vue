<template>
  <!-- 中国建设银行电子签报协办意见单   已办-->
  <div id="signquteFinishxiebGly" class="bank_dispach">
    <el-row>
...
<!-- 【关闭】【维护】【流程调度】【查看正文】【查看流程】【打印处理单】【收藏】 -->
        <div class="grid_comtent">
          ...
          <el-button
            size="small"
            plain
            v-show="bank_selectConfig.curNodeId != '800' && fromdata.isShowLC!=1"
            ...
            <el-row class="pr45">
              ...
              <el-col>
                <el-form-item label="备    注">
                  ...
                  <opinionText 
                    :opinionText="fromdata.agreementOpinionList" 
                    :sendOpinionMaxTime="fromdata.remarkList"
                    :nowUserId="nowUserId"
                    @deletService="deletService"
                    :curNodeCode="fromdata.curNodeCode"
                    :canDelet="false"
  ...
  methods: {
    ...
    async maintenance() {
      ...
      let obj1 = await this.$post
        .postData(
          "getQianbaoXiebanInfoById",
          JSON.stringify(
            Object.assign(data, { function: "getQianbaoXiebanInfoById" })
          ),
          this.$businessCode.qbgl
        )
        .then(res => {
      ...
      let obj2 = await this.$post
        .postData(
          ...
          JSON.stringify(
            Object.assign(data, { function: "getOpinionSysInfoById" })
          ),
          this.$businessCode.qbgl
        )
        .then(res => {
        ...
        let obj3=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysQianbaoFile",tplbsnid: 'KHQB_XB',id: this.$route.query.id})),this.$businessCode.qbgl
          ).then(res => {
            return res.data;
          })
          .catch(err => {
      ...
      const routeData = this.$router.resolve({
        ...
        query: {
          ...
          type: "qb",
          sign: 3,
          selectUrl: "getQianbaoXiebanPoById",
    ...
    getQianbaoXiebanPoById() {
      ...
      this.$post
        ...
        .then(res => {
          ...
          //获取签报处理单主标题
          this.directTitle = res.data && res.data.orgName + "电子签报协办单";
          // 签报依据
          if (
            res.data.sendBasis &&
