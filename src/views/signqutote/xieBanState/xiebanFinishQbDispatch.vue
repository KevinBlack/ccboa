<template>
  <!-- 中国建设银行电子签报协办意见单   已办-->
  <div id="signquteFinishxieb" class="bank_dispach">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent" v-if="fromdata.isMutil == 1">
          ...
          <el-button size="small" plain @click="shxbr('sh')" v-if="fromdata.isShowSendXb=='1'&&!fromdata.isLastXb" v-show="readonlyQbcy">收回多人协办</el-button>
          <el-button size="small" plain @click="shxbr('cb')" v-if="fromdata.isShowSendXb=='1'&&!fromdata.isLastXb" v-show="readonlyQbcy">催办多人协办</el-button>
