<template>
  <!-- 中国建设银行电子签报协办意见单 -->
  <div id="signquteWaitxieb" class="bank_dispach">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent" v-if="fromdata.isMutil == 1">
          ...
          <el-button size="small" plain @click="completeSending" v-if="fromdata.isShowSendXb=='0'&&!fromdata.isLastXb">选择多人协办</el-button>
          <el-button size="small" plain @click="shxbr('sh')" v-if="fromdata.isShowSendXb=='1'&&!fromdata.isLastXb">收回多人协办</el-button>
          <el-button size="small" plain @click="shxbr('cb')" v-if="fromdata.isShowSendXb=='1'&&!fromdata.isLastXb">催办多人协办</el-button>
          <el-button size="small" plain @click="drafting('0')">查看正文</el-button>
          <el-button size="small" plain @click="collect('qianbao_xieban',fromdata.id,fromdata.multiTenancyId)">收藏</el-button>
        ...
        <div class="bank_dispach_file_part">
          ...
          >
            ...
            <div>
              ...
              <el-row>
                <el-col>
                  ...
                  <el-form-item label="签报依据" v-if="showImportData" prop="sendBasis" ref="sendBasis">
                ...
                <el-col>
                  <el-form-item label="协办部门" prop="helpDepartmentName" ref="helpDepartmentName">
                    <el-input
            ...
            <el-row class="pr45">
              ...
              <el-col>
                <el-form-item label="请示单位附件" prop="consultAttachment" ref="consultAttachment">
                  <el-input
                    type="textarea"
                    resize="none"
                    autosize
              ...
              <el-col>
                <el-form-item label="主办部门附件" prop="mainDeptAttachment" ref="mainDeptAttachment">
                  <el-input
                    type="textarea"
                    resize="none"
                    autosize
              ...
              <el-col>
                <el-form-item label="协办部门最终意见" prop="finalOpinion" ref="finalOpinion">
                  <!-- 上面固化，下面临时 -->
                  ...
                  <div class="fix_height">
                    ...
                    ></el-input>
                    <button
                      @click="writelistbox(clickTypes=7,fromdata.finalOpinion&&fromdata.finalOpinion.length)"
                      type="button"
                      class="el-button el-button--default dimi_btn"
              ...
              <el-col>
                <el-form-item label="协办过程意见" prop="processOpinion" ref="processOpinion">
                  ...
                  <div class="fix_height">
                    ...
                    ></el-input>
                    <button
                      @click="writelistbox(clickTypes=8,fromdata.processOpinion&&fromdata.processOpinion.length)"
                      type="button"
                      class="el-button el-button--default dimi_btn"
    ...
    <!-- 多人协办反馈意见弹窗 -->
    <el-dialog v-dialogDrag :before-close="handleCloseManyAssist" title="反馈意见" :visible.sync="shdialog2" width="50%">
      <el-card>
        <el-input
          type="textarea"
          maxlength="500"
...
export default {
  ...
  methods: {
    ...
    sureClearYj() {
      ...
      var obj = Object.assign(this.doDeleteProcessOpinion, parseList);
      obj.function = 'doDeleteProcessOpinion'
      this.$post
        .postData(
          "doDeleteProcessOpinion",
          JSON.stringify(obj),
    ...
    buttonClick(params) {
      switch (params) {
        ...
        case "btn_sc":
          // this.shoucang();
          this.collect("qianbao_xieban",this.fromdata.id,this.fromdata.multiTenancyId)
          break;
        // 查看流程
        case "btn_cklc":
          this.flowScheme();
    ...
    setFormConfig() {
      this.$nextTick(() => {
        this.rules = {
          ...
          helpDepartmentName: [
            {
              required: this.requiredFields.helpDepartmentName,
              trigger: "change",
              message: "请选择协办部门"
            }
          ],
    ...
    //提交最终意见
    async sendFinalIdea() {
      this.fromdata.finalOpinion=this.fromdata.finalOpinion&&this.fromdata.finalOpinion.trim();
      if (!(this.fromdata.finalOpinion || (this.fromdata.finalOpinionList && this.fromdata.finalOpinionList.length))) {
        this.$message({
          type: "error",
          offset: 400,
          showClose: true,
      ...
      // agreementOpinionList handleSituationList  helpOpinionList
      // consultOpinionList  consultAttachment  circulationList
      // remarkList  mainDeptAttachment  finalOpinionList  processOpinionList
      await this.preserve();
    ...
    doBacksyclrHandle() {
      ...
      delete parseList.finalOpinionList;
      delete parseList.processOpinionList;
      var obj = Object.assign({function:"returnBeforeHuman", tplbsnid: "KHQB_XB"}, parseList);
      this.$post
        .postData(
          "returnBeforeHuman",
          JSON.stringify(obj),
    ...
    doFinishManyAssist(){
      if(this.fromdata.processOpinion&&this.fromdata.processOpinion!=''){
        ...
        this.$post
          .postData("doFinishManyAssist", JSON.stringify(params), this.$businessCode.qbgl)
          .then(res => {
            if (res && res.success) {
              this.$message({
                type: "success",
    ...
    async preserve(type) {
      ...
      obj.function = 'saveOrUpdateQianbaoXiebanPo'
      await this.$post
        .postData(
          "saveOrUpdateQianbaoXiebanPo",
          JSON.stringify(obj),
      ...
      if (data) {
        if (this.clickTypes == 1) {
          ...
          if (
            ...
            this.fromdata.agreementOpinion.length >= 500
          ) {
            this.fromdata.agreementOpinion = this.fromdata.agreementOpinion.substr(
              0,
              500
            );
          }
          ...
          this.fromdata.handleSituation = this.fromdata.handleSituation
            ...
            : data;
          if (
            this.fromdata.handleSituation &&
            this.fromdata.handleSituation.length >= 500
          ) {
            this.fromdata.handleSituation = this.fromdata.handleSituation.substr(
              0,
              500
            );
          }
          ...
          this.fromdata.helpOpinion = this.fromdata.helpOpinion
            ...
            : data;
          if (
            this.fromdata.helpOpinion &&
            this.fromdata.helpOpinion.length >= 500
          ) {
            this.fromdata.helpOpinion = this.fromdata.helpOpinion.substr(
              0,
              500
            );
          }
          ...
          if (
            ...
            this.fromdata.consultOpinion.length >= 500
          ) {
            this.fromdata.consultOpinion = this.fromdata.consultOpinion.substr(
              0,
              500
            );
          }
          ...
          this.fromdata.circulation = this.fromdata.circulation
            ...
            : data;
          if (
            this.fromdata.circulation &&
            this.fromdata.circulation.length >= 500
          ) {
            this.fromdata.circulation = this.fromdata.circulation.substr(
              0,
              500
            );
          }
    ...
    //             that.bank_import = res.data;
    //             that.importDataArr.push(res.data);
    //             that.fromdata.sendBasis = that.importDataArr.filter(
