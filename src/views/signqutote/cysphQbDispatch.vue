...
//删除意见(固化意见)
    ...
    //     : sessionStorage.getItem("sCySphSignpageid") || "";
    //   this.$post
    //     .postData(
    //       "selectSWById",
    ...
    getToQianbaoSwEntityById() {
      if (!sessionStorage.getItem("sCySphSignpageid")) {
        this.bank_dispach.id = this.$route.query.id;
      } else {
        this.bank_dispach.id = sessionStorage.getItem("sCySphSignpageid") || "";
      }
    ...
    // 保存
    preserve(type) {
      this.bank_dispach.id = this.$route.query.id?this.$route.query.id:sessionStorage.getItem("sCySphSignpageid") || "";
      ...
      this.$post
        ...
        .then(res => {
          if (res && res.success) {
            ...
            sessionStorage.setItem("sCySphSignpageid", res.data.id);
            if (type) {
              this.$message({
                type: "success",
                showClose: true,
