...
const allData = [
  ...
  { label: "拟稿人", prop: "draftUserName", align: "center" },
  { label: "签报类型", prop: "qianBaoTypeName", align: "center" },
  { label: "签报种类", prop: "orderType", align: "center" }
  ...
  methods: {
    handleSelectionChange(val) {
      ...
      for (var i = 0; i < val.length; i++) {
        idsArr.push({
          ...
          'id': val[i].id,
          'choseYear':this.$route.query.choseYear //tyl
        })
      }
    ...
    timeChange() {
      if (this.ruleForm.endTime) {
        this.getTableOrderAll.createTime = dateFormate.date(
        ...
        this.getTableOrderAll.createTime = "";
    ...
    cellClick(row, column, cell, event) {
      ...
      if (row.orderType == "非跨行") {
        this.handleOpenPage(
          "/signquoteFinishFkhDispatchCopy",
          this.idType,
          this.readType,
          row.orderType,
          this.unitId
        ...
        this.handleOpenPage(
          "/signquoteFinishKhQshDispatchCopy",
          this.idType,
          this.readType,
          row.orderType,
          this.unitId
        ...
        this.handleOpenPage(
          "/signquoteFinishKhSphDispatchCopy",
          this.idType,
          this.readType,
          row.orderType,
          this.unitId
        ...
        this.handleOpenPage(
          "/signquoteFinishEntityDispatchCopy",
          this.idType,
          this.readType,
          row.orderType,
          this.unitId
    ...
    // submitForm() {
    //   this.getTableOrderAll.title = this.ruleForm.title
    //   this.getTableOrderAll.documentNo = this.ruleForm.documentNo;
    //   this.initData();
    // },
    resetForm() {
      //重置
      ...
      this.getTableOrderAll.orgName = this.unitName;
      this.getTableOrderAll.orgId = this.unitId;
      // this.initData();
