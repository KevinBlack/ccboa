<template>
  ...
  <div>
    <div class="dispatchcswhlshwh">
      ...
      <el-dialog :visible.sync="dialogVisible" :modal-append-to-body="false" title="流水号配置">
        ...
        >
          ...
          <el-col>
            <el-form-item label="文件代字" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="年度" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="起始文号" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="当前最大文号" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
        </el-form>
...
const tableCols = [
  { label: "文件代字", prop: "backReason", align: "center" },
  { label: "年度", prop: "backReason", align: "center" },
  { label: "当前最大文号", prop: "backReason", align: "center" }
