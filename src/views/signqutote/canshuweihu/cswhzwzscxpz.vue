    ...
    <div class="dispatchcswhlshwh">
      ...
      <el-dialog :visible.sync="dialogVisible" :modal-append-to-body="false" title="流水号配置">
        ...
        >
          ...
          <el-col>
            <el-form-item label="排序" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="标题关键词" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="字数限制" prop="backReason" ref="backReason">
              <el-input v-model="ruleForm.backReason"></el-input>
            </el-form-item>
          </el-col>
        </el-form>
...
const tableCols = [
  { label: "标题关键词", prop: "backReason", align: "center" },
  { label: "字数限制", prop: "backReason", align: "center" }
];
