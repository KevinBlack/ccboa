<template>
  <!-- 签报实物处理单 已办-->
  <div id="signquteFinishEntity" class="bank_dispach">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="drafting('0')"  v-show="!readonlyQbcy">查看正文</el-button>
...
export default {
  ...
  mixins: [minixs,signquoteIndex,viewDraft,isNowUser],
  data() {
    return {
      readonlyQbcy:true,
      nowUserId: "", //当前用户id
