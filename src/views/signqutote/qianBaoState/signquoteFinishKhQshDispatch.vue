<template>
  <!-- 签报电子处理单  （跨行请示行） 已办-->
  <div id="signquteFinishKh" class="bank_dispach">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="collect('qianbao_qingshi',fromdata.id,fromdata.multiTenancyId)">收藏</el-button>
                ...
                <el-col>
                  <el-form-item label="传阅人员"> 
                      <el-col class="m10 pr45">
                        <el-form-item  label-width="80px" label="未阅" prop="readCirculatePerson" ref="readCirculatePerson">
                          <el-input type="textarea"
                            resize="none"
                            autosize  v-model="fromdata.readCirculatePerson" :disabled="true"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col class="m10 pr45">
                        <el-form-item label-width="80px" label="已阅" prop="endCirculatePerson" ref="endCirculatePerson">
                          <el-input type="textarea"
                            resize="none"
                            autosize v-model="fromdata.endCirculatePerson" :disabled="true"></el-input>
                        </el-form-item>
                      </el-col>
                  </el-form-item>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    takeBackSign(type) {
      ...
      this.$post
        .postData("getSubWfInfoKH", JSON.stringify(parms), this.ggqbgl)
        .then(res => {
          if (res && res.success) {
    ...
    shQueding() {
      ...
      if (this.typeofHQBM === "shouhui") {
        ...
        this.$post
          .postData("takeBackSignHelpKH", JSON.stringify(shform), this.ggqbgl)
          .then(res => {
            if (res.success) {
              this.$message({
                type: "success",
        ...
        this.$post
          .postData("urgeHandleKH", JSON.stringify(parms), this.ggqbgl)
          .then(res => {
            if (res.success) {
              this.$message({
                type: "success",
