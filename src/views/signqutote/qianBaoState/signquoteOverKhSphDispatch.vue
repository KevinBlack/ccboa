<template>
  <!-- 签报电子处理单  （跨行审批行）办结-->
  <div id="signquteOverSph" class="bank_dispach">
    <el-row>
...
<!-- 【关闭】【查看正文】【收回】【催办】【查看流程】【打印处理单】【收藏】【操作指南】 -->
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="collect('qianbao_shenpi',fromdata.id,fromdata.multiTenancyId)">收藏</el-button>
                    ...
                    <el-scrollbar style="padding: 0px 15px 0 0;">
                      ...
                      >
                        <template>
                          <div class="command_file">
                            <span class="order">{{index+1}}.</span>
                            <span class="down"  @click="viewDraftFile(item.fileName,item.filePath ,$businessCode.qbglfj)">{{item.fileName}}</span>
