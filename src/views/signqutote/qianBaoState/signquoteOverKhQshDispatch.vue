<template>
  <!-- 签报电子处理单  （跨行请示行） 办结-->
  <div id="signquteOverQsh" class="bank_dispach">
    <el-row>
...
export default {
  ...
  methods: {
    ...
    getQianbaoKhQingshiPoById() {
      ...
      this.$post
        ...
        .then(res => {
          if(!this.$route.query.From) {this.getIsNowUser(res);}
  ...
  created() {
    ...
    this.bank_dispach.draftDepartmentId = this.$route.query.draftDepartmentId
      ? this.$route.query.draftDepartmentId
      : "";
    //初始化修改交易线 (传后台)
