<template>
  <div class="tablePrint">
    ...
    <el-row>
      <h1 style class="title-h1">{{directTitle}}电子签报退文单</h1>
    ...
    >
      <tbody>
        <tr>
          ...
          <td id="title" colspan="6" style="padding-left:10px;word-break: break-all;">{{fromdata.title}}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td id="phone" style="padding-left:10px;word-break: break-all;" colspan="1">{{fromdata.phone}}</td>
        </tr>
        <tr>
          ...
          <td
            ...
            colspan="4"
            style="padding-left:10px;word-break: break-all;width: 300px;"
        ...
        <tr>
          <td style="text-align: center;width:90px;">退文机构</td>
          <td
            id="createDeptName"
            colspan="2"
            style="padding-left:10px;word-break: break-all;"
          >{{fromdata.createDeptName}}</td>
          <td style="text-align: center;width:90px;">退文人</td>
          <td
            id="createUserName"
            style="padding-left:10px;word-break: break-all;"
            colspan="1"
          >{{fromdata.createUserName}}</td>
          <td style="text-align: center;width:90px;">退文时间</td>
          <td id="backTime" style="padding-left:10px;word-break: break-all;" colspan="1">{{fromdata.backTime}}</td>
        </tr>
        <tr class="print_zr">
          <td style="text-align: center;width:90px;">退文原因</td>
          <td
            id="backExplain"
            colspan="6"
            style="padding-left:10px;word-break: break-all;"
          >{{fromdata.backExplain}}</td>
        </tr>
        <tr>
          <td style="text-align: center;width:90px;">签报依据</td>
          <td id="sendBasis" colspan="6" style="padding-left:10px;word-break: break-all;">
...
export default {
  ...
  created() {
    ...
    this.bank_dispach.unitId = this.$route.query.unitId || "";
    this.bank_dispach.choseYear = this.$route.query.choseYear ? this.$route.query.choseYear : "";
    this.$post
      .postData(
