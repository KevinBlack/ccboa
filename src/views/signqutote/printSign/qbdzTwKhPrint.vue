<template>
  <div class="tablePrint">
    ...
    >
      <tbody>
        <tr  class="print_zr"  v-if="khState == '1'">
          <td class="printSbPsyjMore">上级单位批示意见</td>
        ...
        <tr  class="print_zr" v-if="khState == '1'">
          <td class="printSbPsyjMore">上级单位办理情况</td>
        ...
        <tr  class="print_zr"  v-if="khState == '1'">
          <td style="text-align: center;width:90px;">上级行办理附件</td>
        ...
        <!-- <tr  class="print_zr">
          <td style="text-align: center;width:90px;">协办意见</td>
          <td id="opinionDraf" colspan="6" style="padding-left:10px;">
        ...
        <tr  class="print_zr"  v-if="khState == '1'">
          <td class="printSbPsyjMore">请示单位意见</td>
          <td id="opinionDraf" colspan="6" style="padding-left:10px;">
        ...
        <tr  class="print_zr"   v-if="khState == '2'">
          <td class="printSbPsyj">签批意见</td>
          <td colspan="6" id style="padding-left:10px;">
            <div v-for="item in fromdata.agreementOpinionList" :key="item.id">
              <div v-if="item.status" class="d_flex">
                <el-row class="d_b100">
        ...
        <tr  class="print_zr"  v-if="khState == '2'">
          <td style="text-align: center;width:90px;">请示行附件</td>
          <td colspan="6" id="comments" style="padding-left:10px;">
            <div>
              <el-row>
                <el-col>
        ...
        <tr   v-if="khState == '2'">
          <td style="text-align: center;width:90px;">是否将附件反馈给请示行</td>
          <td colspan="6" id style="padding-left:10px;">{{fromdata.isReturnAttachment}}</td>
        </tr>
    ...
    this.$post
      ...
      .then(res => {
        ...
        if (this.fromdata.isReturnAttachment && this.fromdata.isReturnAttachment == 0) {
            this.fromdata.isReturnAttachment = "否";
          } else {
            this.fromdata.isReturnAttachment = "是";
          }
         this.fromdata.sendBasis = res.data.sendBasis && JSON.parse(res.data.sendBasis)
        this.$forceUpdate()
      })
      .catch(erro => {
        this.$message({
