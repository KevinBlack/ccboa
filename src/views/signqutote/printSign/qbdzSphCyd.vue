    ...
    >
      <tbody>
       ...
       <tr class="print_zr" v-if="fromdata.consultAttachment">
        ...
        <!-- <tr class="print_zr">
          <td style="text-align: center;width:90px;">核稿意见</td>
          <td id="opinionDraf" colspan="6" style="padding-left:10px;">
        ...
        <tr class="print_zr">
          <td style="text-align: center;width:90px;">会签意见</td>
          <td colspan="6" id="opinionSign" style="padding-left:10px;">
        ...
        <tr class="print_zr">
          <td style="text-align: center;width:90px;">拟稿部门意见</td>
        ...
        <!-- <tr class="print_zr">
          <td style="text-align: center;width:90px;">办理情况</td>
          <td id="send_send" colspan="6" style="padding-left:10px;">
