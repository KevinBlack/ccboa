<template>
  <div class="tablePrint">
    ...
    >
      <tbody>
        <tr class="print_zr">
          <td style="border-top: 0px;" class="printSbPsyjMore">上级单位批示意见</td>
          <td id="send_send" colspan="6" style=" padding-left:10px;border-top: 0px;">
        ...
        <tr class="print_zr" v-if="fromdata.upAttchmentFileInfo">
          <td style="text-align: center;width:90px;">上级单位办理附件</td>
        ...
        <!-- <tr class="print_zr" v-if="fromdata.isExceed==1 && wordsLimitInfo.wordsLimit!=0">
          <td style="text-align: center;width:90px;">字数超限原因</td>
          <td id="send_send" colspan="6" style=" padding-left:10px;">
              ...
              <div v-if="item.status" class="d_flex">
                <el-row class="d_b100">
                  <el-col :span="24" class="pos_r">
                    ...
                    <div class="adviceInfo">
                      <p class="pad_yj10">{{item.departmentName}}</p> <span>{{item.userName}}</span>
