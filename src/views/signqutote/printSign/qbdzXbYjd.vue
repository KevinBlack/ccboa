<template>
  <div class="tablePrint">
    ...
    <el-row>
      <h1 style class="title-h1">{{directTitle}}电子签报协办意见单</h1>
    ...
    >
      <tbody>
        <tr>
          ...
          <tr>
            <td style="text-align: center;width:90px;">协办部门</td>
            <!-- <td
           ...
           <td
              id="helpDepartmentName"
              colspan="6"
              style="padding-left:10px;word-break: break-all;"
            >{{fromdata.helpDepartmentName}}</td>
          </tr>

          <tr class="print_zr">
            <td style="text-align: center;width:90px;border-bottom:0;">附件名称</td>
            <td
              id="attachTitle"
              colspan="6"
              style="padding-left:10px;word-break: break-all;white-space: pre-line;border-bottom:0;"
    ...
    >
      <tbody>
        ...
        <tr  class="print_zr">
         ...
         <tr  class="print_zr" v-if="fromdata.consultAttachment">
        ...
        <tr  class="print_zr">
         ...
         <tr  class="print_zr" v-if="fromdata.mainDeptAttachment">
          <td style="text-align: center;width:90px;">主办部门附件</td>
          <td colspan="6" id="comments" style="padding-left:10px;">
            <div>
              <el-row>
                <el-col>
         ...
         <tr  class="print_zr">
          <td class="printSbPsyjMore">协办部门最终意见</td>
          <td id="send_send" colspan="6" style="padding-left:10px;">
         ...
         <tr  class="print_zr">
          <td class="printSbPsyjMore">协办过程意见</td>
          <td id="send_send" colspan="6" style="padding-left:10px;">
                  ...
                  >
                    <el-scrollbar>
                      ...
                      >
                        <template>
                          <div class="command_file">
                            <span class="down" :title="items.fileName">{{items.fileName}}</span>
