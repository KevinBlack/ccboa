  ...
  <div class="tablePrint">
    ...
    <div ref="dyclPrint" class="dyclPrint">
      <el-row id="dyclPrintOne">
        <h1 style class="title-h1">{{directTitle}}电子签报处理单</h1>
      ...
      >
        ...
        <tr class="print_zr" v-if="!hldmsFlag">
        ...
        <tr ref="print_psyj" v-if="hldmsFlag" :class="{'needForcePage':hldmsFlag}">
          <td class="printSbPsyj">批示意见</td>
          <td
            id="send_send"
            colspan="6"
        ...
        <tr class="print_zr" id="huiQianNote">
        ...
        <tr style="min-height: 50px;">
          ...
          <td colspan="5" style=" padding-left:10px;">{{fromdata.readCirculatePerson}}</td>
        </tr>
        <tr style="min-height: 50px;">
          <td style="text-align:center;width:90px;" colspan="1">已阅</td>
          <td colspan="5" style=" padding-left:10px;">{{fromdata.endCirculatePerson}}</td>
        </tr>
        <!-- <tr class="print_zr">
...
export default {
  ...
  mounted() {
    ...
    //   this.printPsyj = 1050 - this.oneHeight;
    //   this.$refs.print_psyj.style.height = this.printPsyj+'px';
    //   // if(this.fromdata.approvalOpinionList && this.fromdata.approvalOpinionList.length<=0){
    ...
    //   //     this.$refs.print_psyj.style.height = (this.printPsyj+'150') +'px';
    //   //   }
    //   // }else{
  ...
  created() {
    ...
    this.$post
      ...
      .then(res => {
        ...
        if (
          res.data &&
          res.data.curNodeName &&
          res.data.curNodeName == "行领导秘书"
        ) {
          this.hldmsFlag = true;
          if (
            this.fromdata.draftDepartmentOpinionList &&
            this.fromdata.draftDepartmentOpinionList.length > 1
          ) {
            this.fromdata.draftDepartmentOpinionList = this.fromdata.draftDepartmentOpinionList.slice(
              0,
              1
            );
          }
