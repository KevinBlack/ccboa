...
跨行无查看流程
 -->
  ...
  <!-- 中国建设银行电子签报退文单 -->
  <div id="signquteKhTuiGly" class="bank_dispach">
    <el-row>
    ...
    async maintenance(){
      let data={
        ...
        let obj3=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysQianbaoFile",tplbsnid: 'KHTW',id: this.$route.query.id, unitId: this.unitId})),this.$businessCode.qbgl
          ).then(res => {
            return res.data;
          })
          .catch(err => {
