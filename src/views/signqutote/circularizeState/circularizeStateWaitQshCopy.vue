      ...
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent" v-else>
          ...
          <!-- <el-button
            ...
            plain
            @click="bankmain('cy')"
            v-if=" state == 0 && fromdata.circulatePersonNames =='' "
          >发传阅</el-button>
          <el-button size="small" plain @click="bankmain('cy',1)" v-else>发传阅</el-button>-->
          <!-- <el-button
            size="small"
            plain
            @click="getTreeDataForCy('cy',1)"
            v-if="fromdata.circulatePersonNames !=''&& FinishFlag"
          >发传阅</el-button>
          <el-button
            size="small"
            plain
...
export default {
  ...
  methods: {
    ...
    saveSending() {
      ...
      // console.error(params.nextNodeName)
  ...
  created() {
    ...
    this.isFinish = this.$route.query.isFinish ? this.$route.query.isFinish * 1 : "";
    this.isEnd = this.$route.query.isEnd ? this.$route.query.isEnd * 1 : "";
    //判断已阅未阅办结单
    // isFinish=1 办结
    ...
    }else if(this.isFinish == 0 && this.isEnd == 1){
      this.FinishFlag = true
    }else if(this.isFinish == 0 && this.isEnd == 0){
      this.FinishFlag = true
    }
    this.selectById();
    // this.selectById("1");
