    ...
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <!-- <el-button class="bank_grid_comtent_active" size="small" @click="maintenance">维护</el-button> -->
...
export default {
  ...
  methods: {
    ...
    saveSending() {
      ...
      this.$post
        .postData("finishAndSendEtc", JSON.stringify(params), this.$businessCode.swgl)
        .then(res => {
          if (res && res.success) {
            this.$message({
              type: "success",
