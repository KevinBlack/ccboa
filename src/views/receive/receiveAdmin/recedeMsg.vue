      ...
      <el-col>
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm mt20 transition_wrap" :class="{mtdown:down}">
          ...
          <div v-if="down" class="clearfix">
            <el-row>
              <el-col :span="8">
                <el-form-item label="退文日期"  prop="recTime">
                <div class="block">
                  <el-date-picker
                  @change="timeChange(events)"
                    v-model="ruleForm.recTime"
                    type="date"
                    align="right"
                    placeholder="选择日期"
            ...
            <el-row>
              <el-col :span = "6">
                <el-form-item label="制发单位" prop="bumen">
...
const otherData = [
        ...
        { label: "退文日期", prop: "time", align: "center" },
        { label: "制发单位", prop: "unit", align: "center" },
        { label: "收文编号", prop: "fileId", align: "center" },
        { label: "标题", prop: "title", align: "center" },
        { label: "退报原因", prop: "reson", align: "center" }
