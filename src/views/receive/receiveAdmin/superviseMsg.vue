      ...
      <el-col>
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm mt20 transition_wrap" :class="{mtdown:down}">
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="收文编号" prop="num">
                <el-input placeholder="请输入" v-model="ruleForm.num"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <div v-if="down" class="clearfix">
            <el-row>
              <el-col :span="9">
                <el-form-item label="督办日期"  prop="supTime">
                <div class="block">
                  <el-date-picker
                  @change="timeChange(events)"
                    v-model="ruleForm.supTime"
                    type="date"
                    align="right"
                    placeholder="选择日期"
            ...
            <el-row>
              <el-col :span="7">
                <el-form-item label="收文单位">
                  <el-input v-model="ruleForm.unit"  readonly="readonly"></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span = "7">
                <el-form-item label="承办部门" prop="bumen">
            ...
            <el-row>
              <el-form-item label="表单类型" prop="formtype">
                ...
                <el-radio :label="1">全部</el-radio>
                  ...
                  <el-radio :label="3">非协办单</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-row>
            <el-row>
              <el-form-item label="督办事项" prop="supmatter">
                <el-radio-group v-model="ruleForm.supmatters">
                <el-radio :label="1">全部</el-radio>
                  <el-radio :label="2">请示事项</el-radio>
                  <el-radio :label="3">其他事项</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-row>
            <el-row>
