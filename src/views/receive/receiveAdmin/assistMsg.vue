<template>
  <div>
    <div>
          ...
          <el-col>
            <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm mt20 transition_wrap" :class="{mtdown:down}">
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label="发文字号" prop="num">
                ...
                <el-row :gutter="18">
                  <el-col :span="6">
                    <el-form-item label="当前环节">
                      <div>
                        <el-select v-model="ruleForm.dvalue" placeholder="请选择">
                          <el-option v-for="item in ruleForm.dlist" :key="item.value" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                       </div>
                    </el-form-item>
                  ...
                  <el-col :span="6">
                    <el-form-item label="序号行名">
                      <div>
                        <el-select v-model="ruleForm.xvalue" placeholder="请选择">
                          <el-option v-for="item in ruleForm.dlist" :key="item.value" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </div>
      ...
      :dialogTit="dialogTit" :checkIds="checkIds" :singelCheckF="singelCheckF" :dialogState="dialogState" @showCompDialog="showCompDialog"></treeCofig>
    </div>
  </div>
</template>
