<template>
  <div id="receiveDzBjYb" class="receive_dispatch">
    <el-row>
              ...
              <el-row>
                ...
                <el-col>
                  <el-form-item label="正文标题">
                    <el-input disabled placeholder="正文标题" v-model="fromdata.title"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                ...
                <el-col>
                  ...
                  <el-form-item label="附件标题">
                    <el-input
                      ...
                      disabled
                    ></el-input>
                    <!-- <el-input type="textarea" autosize resize="none" style="white-space:pre-line;word-break:break-all" placeholder="附件标题" v-model="fromdata.attachmentTitle"></el-input> -->
                  </el-form-item>
                </el-col>
...
export default {
      ...
      this.$post
        ...
        .then(res => {
          if (res.data) {
            ...
            //  if(res.data.isDirect == "0"||res.data.isDirect == "" || !res.data.isDirect){
  ...
  created() {
    ...
    this.uploadConfig.flowTranId = this.$businessCode.swglgg;  //完成并发送 树 流程交易线   chai
