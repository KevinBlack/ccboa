    ...
    <el-row>
      ...
      <el-col style="margin: 20px 0;">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="totleCount" label="公文督查办件数

"></el-table-column>
          <el-table-column prop="sxnzbCount" label="“时限内在办”件数

"></el-table-column>
          <el-table-column prop="asbjCount" label="“按时办结”件数

"></el-table-column>
          <el-table-column prop="csbjCount" label="“超时办结”件数

"></el-table-column>
          <el-table-column prop="cswjCount" label="“超时未结”件数

"></el-table-column>
          <el-table-column prop="avgTime" label="平均办理天数
...
"></el-table-column>
 ...
 <br />（2）公文督办件数：统计时间段内，主办部门主办的公文督办文数量。

 <br />（3）时限内在办件数：以督办单的办理期限为依据（下同），统计时限内未办结的公文数量。

 <br />（4）按时办结件数：统计时段内，在办理期限内办结的公文数量。

 <br />（5）超时办结件数：统计时段内，未在办理期限内办结的公文数量。

 <br />（6）超时未结件数：统计时段内，超过办理期限未办结的公文数量。

 <br />（7）平均办理天数 = 办结督办文件的实际办理时间总和 / 督办件数。
            </td>
...
export default {
  ...
  methods: {
    exportExc() {
      exportTable.exportExcel("督办公文办理情况统计", ".el-table");
    },
    timeChange(events) {
