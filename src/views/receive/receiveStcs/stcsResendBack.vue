    ...
    <el-row>
      ...
      <el-col style="margin: 20px 0;">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="totleCount" label="上报文件总数" style="width:10%;" align="center"></el-table-column>

          <el-table-column label="重发文件" align="center">
            <el-table-column prop="reSendCount" label="件数" style="width:10%;" align="center"></el-table-column>
            <el-table-column prop="reSendRate" label="占比" style="width:10%;" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="被退回文件" align="center">
            <el-table-column prop="backCount" label="件数" style="width:10%;" align="center"></el-table-column>
            <el-table-column prop="backRate" label="占比" style="width:10%;" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="重发、被退回文件合计" align="center">
            <el-table-column prop="resendBackCount" label="件数" style="width:10%;" align="center"></el-table-column>
            <el-table-column prop="resendBackRate" label="占比" style="width:10%;" align="center"></el-table-column>
            <el-table-column prop="sort" label="排名" style="width:10%;" align="center"></el-table-column>
          </el-table-column>
        </el-table>
      </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      ruleForm: {
        function: "statisticsLowerBankReSendAndBackDoc",
        state: 1,
        startTime: "", //   统计起始日期
        endTime: "" //    统计结束日期
      },
  ...
  methods: {
    exportExc(){
      exportTable.exportExcel("收文下机机构重发，被退回文件统计表",".el-table");
    },
    initData() {
      this.$post
        .postData(
          "statisticsLowerBankReSendAndBackDoc",
        ...
        .then(res => {
          ...
          for (const key in this.tableData) {
            if (this.tableData.length == Number(key) + 1) {
              this.tableData[key].sort = "";
            } else {
              this.tableData[key].sort = Number(key) + 1;
            }
          }
        })
        .catch(err => {
