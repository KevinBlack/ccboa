      ...
      <el-col>
        ...
        >
          <el-row>
            ...
            <el-col :span="8" style="width:33.3%;    height: 50px;"></el-col>
            <el-col :span="8">
...
const finshData = [
  ...
  { label: "密级文件", prop: "mjcount", align: "center" },
  { label: "非密级文件", prop: "fmcount", align: "center" },
...
export default {
  ...
  data() {
    return {
      ...
      ruleForm: {
        function: "statisticsReceiveDocSw",
        state: 1,
        startTime: "", //   统计起始日期
        endTime: "" //    统计结束日期
      },
  ...
  methods: {
    exportExc(){
      exportTable.exportExcel("实物收文统计表",".el-table");
    },
    initData() {
      this.$post
        .postData(
          "statisticsReceiveDocSw",
