      ...
      <el-col>
        ...
        >
          ...
          <div v-if="down">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="制发单位" prop="sendOrgName">
                  <el-input v-model="ruleForm.sendOrgName" readonly="readonly" placeholder="请选择或输入">
...
const finshData = [
  ...
  { label: "制发单位", prop: "sendOrgName", align: "center",width:'200' },
  { label: "收文字号", prop: "documentCode", align: "center",width:'200' },
  { label: "标题", prop: "title", align: "left",minwidth:'150' },
  { label: "退文原因", prop: "reason", align: "center",minwidth:'40%' }
];
...
export default {
  ...
  methods: {
    ...
    // 选择时间 退文
    backTimeChange(rangeTime) {
      if(!rangeTime||rangeTime=="null"||rangeTime=="undefined"){
        this.ruleForm.backStartTime = "";
        this.ruleForm.backEndTime = "";
        return false;
      }
      this.ruleForm.backStartTime = dateFormate.date(
        Date.parse(this.backTime[0])
      );
      this.ruleForm.backEndTime = dateFormate.date(
    ...
    resetForm() {
      ...
      this.receiveTime = "", //收文日期值
        this.backTime = "", //退文日期值
        this.ruleForm.function = "selectBackDoc",
        ...
        this.ruleForm.backStartTime = "", //   退文起始日期
        this.ruleForm.backEndTime = "", //   退文结束日期
        this.ruleForm.sendOrgName = ""; //   制发单位
    ...
    //导出
    exportExc(){
      exportTable.exportExcel("收文退回情况查询统计表",".el-table");
    },
    routeYear(){
      this.$router.push({
        query: {
  ...
  created() {
    ...
    if(sessionStorage.getItem('page_sw')){
      ...
      if(this.ruleForm.backStartTime&&this.ruleForm.backEndTime){
        this.backTime=[this.ruleForm.backStartTime,this.ruleForm.backEndTime]
      }
      this.pagination={
