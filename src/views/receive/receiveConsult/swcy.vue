  ...
  <div>
    <el-row class="mtJ20">
              ...
              <el-col :span="8">
                ...
                <el-form-item label="制发行" prop="sendOrgName">
                  <select-org-or-dept @select="selectIssue">
                    <el-input type="text" readonly="readonly" placeholder="请选择" v-model="ruleForm.sendOrgName" suffix-icon="el-icon-arrow-down" />
                  </select-org-or-dept>
                </el-form-item>
              </el-col>
              <el-col :span="8">
      ...
      <el-col style="margin: 30px 0;" :class="{'is3':!down}">
        ...
        <m-table v-show="false" id="custom" class="custom" size="medium" :isSelection="false" :isIndex="true" :isPagination="true" :isHandle="false" :tableData="tableData1" :tableCols="tableColsCustom" :pagination="pagination" @handleCurrentChange="handleCurrentChange" @handleSizeChange="handleSizeChange" @cellClick="cellClick" v-loading="tableLoading" :default-sort="sortDate"></m-table>
      </el-col>
    </el-row>
    ...
    <treeAll :treeData="treeData" :canTab="canTab" :loadingTree="loadingTree" :hasRadio="hasRadio" :dialogType="dialogType" :dialogTypeNow="dialogTypeNow" :dialogTit="dialogTit" :checkIds="checkIds" :checkData="checkData" :singelCheckF="singelCheckF" :dialogState="dialogState1" :offenUse="offenUse" :fromdata="ruleForm" :seletOptionsData="seletOptionsData" @showCompDialog="showCompDialog" :treeTradeCode="treeTradeCode"></treeAll>
...
export default {
  ...
  methods: {
    ...
    async handleReqAllData() {
      ...
      this.bank_select1.function = "selectReceiveZDY"
      this.bank_select1.page = this.exportNum;
      this.bank_select1.limit = 5000;
      this.bank_select1.total = 0;
      await this.$post.postData("selectReceiveZDY", JSON.stringify(Object.assign({}, this.bank_select1)), this.$businessCode.swgl).then(res => {
        if (res.success) {
    ...
    initData() {
      ...
      this.ruleForm.function = "selectReceive";
      this.$post
        .postData(
          "selectReceive",
    ...
    resetForm(formName) {
      ...
      this.ruleForm.documentCode = "〔" + nowYear + "〕";
      this.ruleForm.title = "";
