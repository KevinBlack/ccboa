<template>
  <div id="shiwucbDetail" class="receive_dispatch">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button plain @click="commit">提交最终意见</el-button>
          ...
          <!-- <el-button size="small" plain @click="clearMassage">清空过程意见</el-button> -->
          <el-button
            size="small"
    ...
    <!-- 收回弹窗 -->
    <el-dialog title="收回" :visible.sync="shdialog" width="50%">
      <el-card>
...
<!--                <el-col>
            ...
            <el-row class="pr45">
              <el-col>
                <el-form-item label="批示意见">
                  <el-input
                    ...
                    resize="none"
                    autosize
                    v-if="fromdata.pishiOpinionList==''||!fromdata.pishiOpinionList"
                    disabled
                  ></el-input>
                  <opinionText
              ...
              <el-col>
                <el-form-item label="办公室批办意见">
                  <el-input
                    type="textarea"
                    v-if="fromdata.officeOpinionList==''||!fromdata.officeOpinionList"
                    disabled
                  ></el-input>
                  <opinionText
              ...
              <el-col>
                <el-form-item label="备    注">
                  <el-input
                    ...
                    resize="none"
                    autosize
                    v-if="fromdata.remarksList==''||!fromdata.remarksList"
                    disabled
                  ></el-input>
                  <opinionText
            ...
            <el-row class="pr45">
              <el-col>
                <div
                  class="file_list_box"
                  v-if="fromdata.receiveDocFileList&&fromdata.receiveDocFileList.length"
                >
                  <el-scrollbar>
                    <div
                      v-for="(item,index) in  fromdata.receiveDocFileList"
                      :key="item.id"
                      class="comp_list"
                    >
                      <template>
              ...
              <el-col v-if="fromdata.undertakeFileList&&fromdata.undertakeFileList.length">
                <el-form-item label="反馈附件">
                  <uploadFiles
                    ref="uploadComponent"
                    @preserve="preserve"
                    :uploadConfig="uploadConfig1"
                  ></uploadFiles>
                  <div class="tree_w">
                    <el-scrollbar>
                      <div
                        v-for="(item,index) in  fromdata.undertakeFileList"
                        :key="item.id"
                        class="comp_list"
                      >
                        <template>
                ...
                <el-form-item label="过程意见">
                  <div class="fix_height">
                    <el-input
                      ...
                      v-if="!editedIdeaFields.processOpinion  || (editedIdeaFields.processOpinion && !(fromdata.processOpinionList && fromdata.processOpinionList.length))"
                    ></el-input>
                    <button
...
export default {
  ...
  data() {
    return {
      ...
      swglggCode: this.$businessCode.swgl,
  ...
  methods: {
    ...
    takeBackSign() {
      ...
      this.$post
        .postData("takeBackSignHelp", JSON.stringify(parms), this.swglggCode)
        .then(res => {
          if (res && res.success) {
      ...
      this.$post
        ...
        .then(res => {
          if (res.data) {
            ...
            this.$post
              .postData(
                ...
                JSON.stringify({
                  ...
                  processInstId: this.bank_sendXb.processInstId
                }),
                this.swglggCode
              )
              .then(res => {
            ...
            // this.cuteData("finalOpinion", "finalOpinionList", "finalOpinionId");
            // this.cuteData("processOpinion", "processOpinionList", "processOpinionId");
            // this.cuteData(
            //   "handleTerminateOpinion",
            //   "handleTerminateOpinionList",
            //   "handleTerminateOpinionId"
            // );
            // console.log(res.data.handleTerminateOpinionList)
            // this.cuteData(
            //   "officeOpinion",
            //   "officeOpinionList",
            //   "officeOpinionId"
    ...
    receiveselectlist() {
      this.uploadConfig1.id = this.receiveselect.id = this.receiveselect.id
    ...
    async preserve(type) {
      ...
      let params = Object.assign(this.saveOrUpdateSW, copyFrom);
    ...
    commit() {
      ...
      this.cantDisabled = true;
      this.$post
        .postData("doFinishHQXBCB", JSON.stringify(obj), this.swglggCode)
        .then(res => {
          if (res && res.success) {
            this.$message({
              type: "success",
    ...
    upRow(n) {
      ...
      this.fromdata.undertakeFileList[n] = this.fromdata.undertakeFileList[
      n - 1
        ];
