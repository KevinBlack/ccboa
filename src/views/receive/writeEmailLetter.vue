    ...
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="preserve('3')">保存并登记</el-button>
              ...
              <el-row style="margin-top:40px;">
                ...
                <el-col :span="8">
                  <el-form-item label="密级" :span="8" prop="security" ref="security">
                    <el-select v-model="fromdata.security" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="缓急" :span="8" prop="emergencyName" ref="emergencyName">
                    <el-select v-model="fromdata.emergencyName" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="收件编号" prop="fileCode" ref="fileCode">
                    <el-input v-model="fromdata.fileCode"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="数量" prop="count" ref="count">
                    <el-input-number v-model="fromdata.count" :min="0" ></el-input-number>
                  </el-form-item>
                </el-col>
                <!-- <el-col :span="24">
                ...
                <el-col :span="24">
                  <el-form-item label="来件单位" prop="sendDeptName" ref="sendDeptName" style="overflow:hidden;height: 40px;">
                    <el-input
                      v-model="fromdata.sendDeptName"
                      placeholder="请选择来件单位"
                      style="width: 95%;z-index: 2;"
                    ></el-input>
                    <el-select v-model="fromdata.sendDeptName" placeholder="请选择" style="width: 100%;z-index: 1;position:absolute;left: 0;">
                      <el-option
                        v-for="item in SendDept"
                        :key="item.value"
                        :label="item.value"
                ...
                <el-col>
                  ...
                  <el-form-item label="备    注">
                    <el-input v-model="fromdata.remark" type="textarea" resize="none" maxlength='500'
                      autosize placeholder="填写备注"></el-input>
