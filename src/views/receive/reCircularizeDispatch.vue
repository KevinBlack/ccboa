<template>
  <div id="reCircularizeDispatch" class="receive_dispatch">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent" v-else>
          ...
          <el-button
            ...
            plain
            @click="getTreeDataForCy('cy')"
            v-if="fromdata.showCy&&state==2"
            v-show="readonlySwcy"
          >发传阅</el-button>
          <el-button size="small" plain @click="yiyue" v-if="state == 0" v-show="readonlySwcy">已阅</el-button>
          <el-button
            size="small"
            plain
            @click="yiyue('1')"
            v-if="state==0 && !fromdata.disabledAndNoneFkButton"
            v-show="readonlySwcy"
          >反馈传阅意见</el-button>
          <el-button size="small" plain @click="processSheet('/swcycld')">打印处理单</el-button>
          <el-button size="small" plain @click="shoucang">收藏</el-button>
        ...
        <div class="bank_dispach_file_part">
          ...
          >
            ...
            <div class="bank_dispach_annotation">
              <el-row>
                <el-col :span="14" style="display:flex" v-if="fromdata.curNodeCode!=800">
                  <p class="bank_dispach_annotation_current">
                    当前处理人：
                    <span>{{ curUser }}</span>
                  </p>
                </el-col>
                <el-col :span="fromdata.curNodeCode==800?24:10">
                  <el-form-item label="是否阅件:" style="float: right;padding-right: 20px;">
                    <el-radio v-model="fromdata.isRead" :label="1" disabled>是</el-radio>
                    <el-radio v-model="fromdata.isRead" :label="0" disabled>否</el-radio>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
            ...
            <div>
              <el-row>
                ...
                >
                  ...
                  <el-col :span="8">
                    <el-form-item label="直发文种类" v-if="isDirectFlag">
                      <el-select
                        disabled
                  ...
                  <el-col>
                    <el-form-item label="保管期限" prop="keepingLimit" ref="keepingLimit">
                      <el-input v-model="fromdata.keepingLimit" disabled></el-input>
                    </el-form-item>
                  </el-col>
                </div>
                <el-col>
              ...
              <el-col>
                <el-form-item label="批示意见">
                  <el-input
                    ...
                    resize="none"
                    autosize
                    v-if="fromdata.pishi_opinion==''||!fromdata.pishi_opinion"
                    disabled
                  ></el-input>
                  <opinionText
                    :opinionText="fromdata.pishi_opinion"
              ...
              <el-col>
                <el-form-item label="办公室批办意见">
                  <el-input
                    ...
                    resize="none"
                    autosize
                    v-if="fromdata.office_opinion==''||!fromdata.office_opinion"
                    disabled
                  ></el-input>
                  <opinionText
                    :opinionText="fromdata.office_opinion"
                    :sendOpinionMaxTime="fromdata.opinionMaxTime"
                    :nowUserId="nowUserId"
                    :canDelet="false"
                    :curNodeCode="fromdata.curNodeCode"
              ...
              <el-col>
                <el-form-item label="协办部门办理情况">
                  <el-input
                    ...
                    resize="none"
                    autosize
                    v-if="fromdata.help_org_opinion==''||!fromdata.help_org_opinion"
                    disabled
                  ></el-input>
                  <opinionText
            ...
            <template>
              ...
              <el-row class="pr45">
                <!-- <el-col>
                  <el-form-item label="一次传阅意见" v-if="firstOp">
                    ...
                    <el-input
                      type="textarea"
                      resize="none"
                      v-if="!fromdata.firstOpinions||fromdata.firstOpinions == '[]'||fromdata.firstOpinions.length=='0'"
                      autosize
                      disabled
                    ></el-input>
                  </el-form-item>
                ...
                <el-col>
                  <el-form-item label="办结情况">
                    <el-input
                      ...
                      resize="none"
                      autosize
                      v-if="fromdata.handle_terminate_opinion==''||!fromdata.handle_terminate_opinion"
                      disabled
                    ></el-input>
                    <opinionText
                      :opinionText="fromdata.handle_terminate_opinion"
                      :sendOpinionMaxTime="fromdata.opinionMaxTime"
                      :nowUserId="nowUserId"
                      :canDelet="false"
                      :curNodeCode="fromdata.curNodeCode"
                ...
                <el-col>
                  <el-form-item label="备    注">
                    <el-input
                      ...
                      resize="none"
                      autosize
                      v-if="fromdata.remarks==''||!fromdata.remarks"
                      disabled
                    ></el-input>
                    <opinionText
                      :opinionText="fromdata.remarks"
                      :sendOpinionMaxTime="fromdata.opinionMaxTime"
                      :nowUserId="nowUserId"
                      :canDelet="false"
                      :curNodeCode="fromdata.curNodeCode"
                  ...
                  <el-form-item label="传阅意见" prop="opinions" ref="opinions">
                    <div class="fix_height">
                      <el-input
                        ...
                        maxlength="500"
                        autosize
                        :disabled="fromdata.disabledAndNoneFkButton"
                      ></el-input>
                      <button
            ...
            <el-row class="pr45">
              ...
              <el-col v-for="(item,n) in fkfj" :key="n">
                <el-form-item :label="item" :key="item">
                  <el-scrollbar>
                    <div v-for="(item1,index) in fkfjList[n]" :key="item1.id" class="file_list_box">
                      <template>
                        <div class="command_file">
                          <span class="order">{{ index + 1 }}.</span>
                          <span
...
export default {
  ...
  data() {
    return {
      ...
      fromdata: {
        ...
        disabledAndNoneFkButton: false //传阅意见框不可编辑,反馈传阅按钮隐藏
      },
      selectContents: {
  ...
  methods: {
    ...
    yiyue(n) {
      ...
      this.$post
        .postData("areadlyRead", JSON.stringify(copyFrom), this.swglggCode)
        .then(res => {
          if (res && res.success) {
            this.$message({
              type: "success",
    ...
    writelistvalue(data) {
      if (data) {
        if (this.clickTypes == 1) {
          ...
          this.concatAttrData("opinions", data);
        }
        this.$forceUpdate();
      }
    },
      ...
      this.$post
        ...
        .then(res => {
          if (res.data) {
            ...
            if (this.scircularizeLevel == "2") {
              this.orgId = this.fromdata.deptId;
            } else {
              this.orgId = "";
            }
            console.log(res.data.disaledUserId);
            ...
            // if(this.fromdata.firstOpinions&&this.fromdata.firstOpinions instanceof Array){
            //   this.firstOp=true;
            // }
            //已上传的文件
            ...
            //临时意见处理
            this.cuteData("pishiOpinion", "pishi_opinion", "pishiOpinionId");
            this.cuteData("remarks", "remarks", "remarksId");
            this.cuteData(
              "handleTerminateOpinion",
              "handle_terminate_opinion",
              "handleTerminateOpinionId",
              "undertake_org_opinion",
              "help_org_opinion"
            );
            this.cuteData("officeOpinion", "office_opinion", "officeOpinionId");
          }
        });
    },
    shoucang() {
    ...
    processSheet(path, id) {
      const routeData = this.$router.resolve({
        ...
        query: {
          id: this.fromdata.id,
          mainDocId: this.receiveselect.mainDocId,
          multiTenancyId: this.receiveselect.multiTenancyId,
    ...
    async preserve(type) {
      ...
      delete copyFrom.remarks;
      delete copyFrom.handle_terminate_opinion;
      delete copyFrom.pishi_opinion;
      delete copyFrom.office_opinion;
      delete copyFrom.undertake_org_opinion;
      delete copyFrom.attchmentFileInfo;
      delete copyFrom.finalOpinionList;
      delete copyFrom.help_org_opinion;
      delete copyFrom.feedbackAttachmentMap;
      let obj = Object.assign(this.saveOrUpdateSW, copyFrom);
      let successState = false;
      await this.$post
        .postData("doSaveOrUpdateCY", JSON.stringify(obj), this.swglCode)
        .then(res => {
          if (res && res.success) {
            if (type && type != "2") {
              this.$message({
  ...
  created() {
    ...
    this.receiveselect.mainDocId = this.$route.query.mainDocId
      ? this.$route.query.mainDocId
      : "";
    this.receiveselect.multiTenancyId = this.$route.query.multiTenancyId
      ? this.$route.query.multiTenancyId
      : "";
    this.state = this.$route.query.state ? this.$route.query.state : "";
    this.uploadConfig.flowTranId = this.treeTradeCode = this.$businessCode.swglgg;
    this.readFlag = this.$route.query.readFlag
      ? this.$route.query.readFlag
      : "";
    this.readonlySwcy = this.$route.query.tiaoguo ? false : true;
    if (this.$route.query.tiaoguo) {
      this.fromdata.disabledAndNoneFkButton = true;
    }
    this.receiveselectlist();
  },
  destroyed() {
