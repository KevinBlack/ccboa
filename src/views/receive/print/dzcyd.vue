<template>
  <div class="tablePrint">
    <!-- 1)	电子收文传阅单 -->
    <el-row>
      <h1 style="" class="title-h1">中国建设银行电子收传阅单</h1>
    ...
    <table cellspacing="0" cellpadding="0" class="printTableList" style="font-family: 宋体;font-size: 19px;"
      ...
      <tr style="height: 32px;">
        <td style="text-align:center">文&nbsp;&nbsp;种</td>
        <td colspan="3" style="padding-left: 10px;">{{ fromdata.isDirect }}</td>
      ...
      <tr style="height: 100px;">
        <td style="text-align:center">一次传阅<br>意见</td>
        <td colspan="5" style="padding-left: 10px;">{{ fromdata.helpOrgOpinion }}</td>
      </tr>
      <tr style="height: 100px;">
        <td style="text-align:center">二次传阅<br>意见</td>
        <td colspan="5" style="padding-left: 10px;">{{ fromdata.helpOrgOpinion }}</td>
      </tr>
      <tr style="height: 100px;">
      ...
      <tr style="height: 100px;">
        <td style="text-align:center">一次传阅<br>人员</td>
        <td colspan="5" style="padding-left: 10px;">{{ fromdata.helpOrgOpinion }}</td>
      </tr>
      <tr style="height: 50px;">
        <td rowspan="2" style="text-align:center">二次传阅人员</td>
