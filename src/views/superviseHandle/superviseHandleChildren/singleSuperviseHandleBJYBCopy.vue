<template>
  <div id="singleSuperviseHandleBJYBCopy" class="bank_dispach">
    <el-row>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label="办理期限" prop="expireDate" ref="expireDate">
                    <el-input v-model="fromdata.expireDate" disabled  @change="isNumber"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="2">
                   <el-button slot="append">{{fromdata.handleTime}}</el-button>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="联系电话" prop="contactPhone" ref="contactPhone">
                    <el-input v-model="fromdata.contactPhone" disabled
                     ></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                ...
                <!-- <el-col>
                  <el-form-item label="传阅人员" prop="circllateName" ref="circllateName">
                    <el-input v-model="fromdata.circllateName" :disabled="readFields.circllateName"></el-input>
                  </el-form-item>
                </el-col> -->
              </el-row>
            </div>
              ...
              <el-row class="pr45">
                ...
                <el-col :span="24">
                  <el-form-item label="催查记录" prop="documentNo" ref="documentNo">
                    <el-input v-model="nodata" type="textarea" resize="none"
...
export default {
  ...
  data() {
    return {
      ...
      treeJyx: this.$businessCode.zxdb,//公共交易线
  ...
  methods: {
    ...
    async maintenance(){
        ...
        let obj1=await this.$post.postData(
            "getSysSupervise",
            JSON.stringify(Object.assign(data,{function :"getSysSupervise",superviseDirect: '1'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        let obj2=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysSuperviseOpinion",superviseDirect: '1'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        let obj3=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysSuperviseFile",superviseDirect: '1'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
    ...
    collect() {
      let shiwutitle = (this.fromdata.superviseDeptName||'') + '单项督办处理单'
      exportTable.getPdf(shiwutitle, this.fromdata.attchmentFileInfo, "singleSuperviseHandleBJYB")
    },
    //清空处理
    clearCheckData(name) {
      //手动清空时处理
