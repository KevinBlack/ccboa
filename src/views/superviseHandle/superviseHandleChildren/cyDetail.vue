							...
							<el-row>
								...
								<el-col :span="8">
									<el-form-item label="登记日期" prop="registDate" ref="registDate">
										<el-input v-model="fromdata.registDate" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8">
									<el-form-item label="结项日期" prop="finishDate" ref="finishDate">
										<el-input v-model="fromdata.finishDate" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8" v-if="this.$route.query.openType == 'cb'">
									<el-form-item label="截止时间" prop="expectFinishTime" ref="expectFinishTime">
										<el-input v-model="fromdata.expectFinishTime" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="6" v-if="this.$route.query.openType == 'dx'">
									<el-form-item label="办理期限" prop="expireDate" ref="expireDate">
										<el-input v-model="fromdata.expireDate" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="2" v-if="this.$route.query.openType == 'dx'" style="text-align:right">
								...
								<el-col :span="8">
									<el-form-item label="督办部门" prop="superviseDeptName" ref="superviseDeptName">
										<el-input v-model="fromdata.superviseDeptName" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8">
									<el-form-item label="联系人" prop="contact" ref="contact">
										<el-input v-model="fromdata.contact" :disabled="true"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8">
									<el-form-item label="联系电话" prop="contactPhone" ref="contactPhone">
										<el-input v-model="fromdata.contactPhone" :disabled="true"></el-input>
									</el-form-item>
								</el-col> 
								<el-col>
								...
								<el-col>
									<el-form-item label="传阅人员" prop="circulatePersonNames" ref="circulatePersonNames">
										<el-input
											...
											style="width: 100%;"
										>
										<el-button slot="append" @click="takeBackSignCY('shouhui','cy')" v-if="fromdata.circulatePersonNames !=''&&state==0">收回</el-button>
										</el-input>
									</el-form-item>
								</el-col>
								</el-row>
						...
						<el-row class="pr45">
								...
								<el-col :span="24">
									...
									>
										...
										<el-input type="textarea"
											resize="none"
											autosize
											v-model="fromdata.superviseFinishOpinion" :disabled="true"
								...
								<el-col v-if="fromdata.firstOpinions&&fromdata.firstOpinions.constructor == Object">
									<el-form-item label="一次传阅意见">
										<!-- <div>
											<div class="d_flex"  v-if="fromdata.firstOpinions.opinions&&fromdata.firstOpinions.opinions!=''">
												<el-row class="d_b100">
													<el-col
														:class="['pos_r']"
													>
														...
														></el-input>
                              							<div class="adviceInfo" style="line-height: 15px">
															...
															<span class="pad_lr10">{{fromdata.firstOpinions.curUser}}</span>
															<br>
										...
										<el-row>
											<el-col class="m10">
												<el-form-item label="一次传阅人" prop="firstCirculateHumans" ref="firstCirculateHumans">
													<el-input type="textarea"
														resize="none"
														autosize v-model="fromdata.firstCirculateHumans" :disabled="true"></el-input>
												</el-form-item>
											</el-col>
											<el-col class="m10">
												<el-form-item label="二次传阅人(未阅)">
													<el-input type="textarea"
														resize="none"
														autosize v-model="fromdata.wBJSecondCirculate" :disabled="true"></el-input>
												</el-form-item>
											</el-col>
											<el-col class="m10">
												<el-form-item label="二次传阅人(已阅)" prop="yBJSecondCirculate" ref="yBJSecondCirculate">
													<el-input type="textarea"
														resize="none"
														autosize v-model="fromdata.yBJSecondCirculate" :disabled="true"></el-input>
												</el-form-item>
											</el-col>
										</el-row>
									</el-form-item>
	...
	methods: {
      ...
      let data={
        ...
        let obj1=await this.$post.postData(
            "getSysSupervise",
            JSON.stringify(Object.assign(data,{function :"getSysSupervise",superviseDirect: '5'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        // if(obj1&&obj2){
          const routeData = this.$router.resolve({
              ...
              query: {
                ...
                type:'db',
                sign: '5',
                selectUrl: this.openTypeFunction,
