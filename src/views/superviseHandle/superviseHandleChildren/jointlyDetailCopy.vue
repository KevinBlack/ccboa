<template>
  <div id="jointlyDetailCopy" class="bank_dispach">
    <el-row>
          ...
          >
            ...
            <el-row class="pr45">
              ...
              <el-form-item label="反馈附件">
                <div class="file_list_box" style="margin-left:0;" v-if="fromdata.assistAttchmentFileInfo&&fromdata.assistAttchmentFileInfo.length">
                  <el-scrollbar>
...
export default {
  ...
  data() {
    return {
     ...
     fromdata: {
      ...
      treeJyx:this.$businessCode.zxdb,
      handleDays:[],
      projectBaseList: [],
      SredHead: [],
      SemergencyLevel: [],
  ...
  methods: {
    async processScheduling() {
      ...
      this.fromdata.nextNodeId = this.bank_doSend.nextNodeId ;
    ...
    async maintenance(){
        let data = Object.assign(this.fromdata,{
          id: this.$route.query.id,
          title: '中国建设银行专项督查办协办单',
          manager:'',
          unitId:this.$route.query.unitId,
        })
        let obj1=await this.$post.postData(
            "getSysSupervise",
            JSON.stringify(Object.assign(data,{function :"getSysSupervise",superviseDirect: '4'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        let obj2=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysSuperviseOpinion",superviseDirect: '4'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        let obj3=await this.$post.postData(
            ...
            JSON.stringify(Object.assign(data,{function :"selectSysSuperviseFile",superviseDirect: '4'})),this.$businessCode.zxdb
          ).then(res => {
            return res.data;
          })
          .catch(err => {
   ...
   // 下拉列表
    ...
    //提交最终意见
    doAssistFinish(){
      if((this.fromdata.opinionFinalList?false:true)&&this.fromdata.opinionFinal == ""){
          this.$message({
            message:'请填写最终意见',
            type: "error",
            duration: 1500,
    ...
    preserve(type) {
      ...
      // delete copyFrom.opinionSuperviseFinishList;
      // delete copyFrom.opinionSuperviseSetupList;
      // delete copyFrom.opinionFinalList;
      // delete copyFrom.opinionProcessList;
