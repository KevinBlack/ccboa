    ...
    <el-row class="mtJ20">
      <el-col v-show="iaAll">
        ...
        >
          <el-row>
            <el-col :span="8">
              <el-form-item label="机构名称" :disabled="!isGly">
            ...
            <el-col :span="8">
              <el-form-item label="事由提要" prop="title">
      ...
      <el-col style="margin: 20px 0;min-height:500px;">
        <m-table
          size="medium"
          :isSelection="true"
          :isIndex="true"
...
export default {
  ...
  methods: {
    ...
    handleBatchDelete () {
      ...
      JSON.stringify({ function: 'doLogicDeleteById',unitId:this.unitId, ids: this.deleteIds,code:"3" }),
    ...
    initDbData(tabindex) {
      ...
      this.pageNum()      
      this.bank_db.state = tabindex?tabindex:this.bank_db.state;
      this.$post
        .postData(
          "getWFTask",
    ...
    pageNum(){
      this.bank_db.totalCount = (this.bank_db.page-1)*this.bank_db.limit
    },
    arrow() {
      this.down = !this.down;
    },
    ...
    handleCurrentChange(val) {
      ...
      if(this.tableCols === finshData){
        console.log('state',this.bank_db.state)
