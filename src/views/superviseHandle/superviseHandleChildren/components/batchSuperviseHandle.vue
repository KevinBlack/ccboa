      ...
      <el-col v-if="iaAll">
        ...
        >
          <el-row>
            ...
            <el-col style="text-align: center;" class="glymt10">
  ...
  data() {
    return {
      ...
      bank_countersignature: {
        function: "getWFTask",
        tplbsnid:'PLZXDB', 
        state: 0, //全部0 待办1  已办2  办结3selectBatchByPage
        page: 1, //当前页数
        limit: 20, //每页条数
        totalCount:0,
        startDate: '',
  ...
  methods: {
    ...
    initData(tabindex) {
      ...
      if(this.bank_countersignature.state == "0"){
        ...
        Object.assign(this.bank_countersignature,{function:"sysSupervisePage",superviseDirect: '2'})
        this.$post
        .postData(
          "sysSupervisePage",
