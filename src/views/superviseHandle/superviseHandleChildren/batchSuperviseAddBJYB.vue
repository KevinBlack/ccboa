<template>
  <div id="app" class="bank_dispach">
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
            ...
            <el-button size="small" @click="instructions" plain>操作指南</el-button>
        </div>
      </el-col> 
    </el-row>
    <el-dialog
    ...
    <header class="bank_dispach_header">
      <h3 class="bank_dispach_tit">中国建设银行专项督查办批量处理单</h3>
    </header>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="立项依据" prop="projectBase" ref="projectBase">
                    <el-select v-model="fromdata.projectBase" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="督办部门" prop="superviseDeptName" ref="superviseDeptName">
                    <el-input v-model="fromdata.superviseDeptName"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="联系电话" prop="contactPhone" ref="contactPhone">
                    <el-input v-model="fromdata.contactPhone" oninput="value=value.replace(/[^\-\,\d\*\ ]/g,'')"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="督办依据" prop="superviseBasis" ref="superviseBasis">
                    <el-input v-model="fromdata.superviseBasis">
                      <el-button slot="append" @click="appendMassage(fromdata.superviseBasis)">引入</el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                ...
                <el-col>
                  <el-form-item label="批量督办事项" prop="type" ref="type">
                    <template>
                      ...
                      <el-button @click="plsh" v-if="fromdata.batchStatus == 1">批量收回</el-button>
              ...
              <el-row>
                ...
                <el-col :span="24">
                  ...
                  >
                    ...
                    <el-input type="textarea"
                      resize="none"
                      autosize v-model="fromdata.superviseFinishOpinion"
                      v-if="!(fromdata.opinionSuperviseFinishList && fromdata.opinionSuperviseFinishList.length)"
                      ></el-input>
                    <!-- <el-input v-model="fromdata.superviseFinishOpinion" :disabled="editedIdeaFields.superviseFinishOpinion" type="textarea"></el-input> -->
                  </el-form-item>
                </el-col>
                <el-col :span="24">
                  <el-form-item label="批量督办办结情况" prop="setUpInfo" ref="setUpInfo">
                    ...
                    <el-input type="textarea"
                      resize="none"
                      autosize v-model="fromdata.finishDetail"
                ...
                <el-form-item :label="item" :key="item">
                  <el-scrollbar>
                    <div v-for="item1 in fkfjList[n]" :key="item1.id" class="tree_w">  
                      <template>
                        <div class="command_wrap">
                          <span class="name down" :title="item.fileName" @click="viewFile(item1)">{{item1.fileName}}</span>
    ...
    return {
      ...
      tableCols: [
        ...
        { label: "协办单位", prop: "assistOrganName", align: "center" },
        {
          ...
          color:"blue",
          formatter(row){
            return row.isUndertakeOver ==1 ? "已反馈": (row.isUndertakeOver ==2? "持续跟踪":" ");
          },
        },
        {
          label: "操作 ",
      ...
      rules:{
          ...
          superviseCode: [{required:true,trigger: "change",message: "请选择编号"}],
          ...
          title: [{required:true,trigger: "change",message: "请选择协办单位"}],
        },
      imageUrl: "",
      fileList: [],
      timeShow: false, //查看流程
          ...
          if(this.fromdata.batchStatus == '1'){
            this.tableCols = [
                  ...
                  { label: "协办单位", prop: "assistOrganName", align: "center" },
                  {
                    ...
                    color:"blue",
                    formatter(row){
                      return row.isUndertakeOver ==1 ? "已反馈": (row.isUndertakeOver ==2? "持续跟踪":"未反馈");
                    },
                  },
                ];
          }
