    ...
    <!-- <thead style="border:none">
      ...
      <tbody>
        <tr>
          ...
          <td style="padding-left: 10px;">{{fromdata.doucumentNum}}</td>
        </tr>
        <tr>
       ...
       <tr class="print_zr">
        ...
        <tr class="print_zr" v-if="(fromdata.opinionDbOrgList&&fromdata.opinionDbOrgList.length!=0)||fromdata.isUndertakeOverpl==2">
        ...
        <tr>
					...
					<td style="padding-left: 10px;" colspan="2">{{fromdata.underTakeStartTime}}</td>
					<td style="text-align: center;">承办完毕时间</td>
					<td style="padding-left: 10px;" colspan="2">{{fromdata.underTakeEndTime}}</td>
        </tr>
        <tr>
          <td style="text-align: center;">承办人</td>
          <td style="padding-left: 10px;" colspan="2">{{fromdata.underTakeUser}}</td>
          <td style= "text-align: center;">联系电话</td>
          <td style="padding-left: 10px;" colspan="2">{{fromdata.underTakePhone}}</td>
        </tr>
        <tr class="print_zr">
