    ...
    <el-tabs v-model="typeFW" @tab-click="tabsClickDEPT_FW" style="height:30px;">
      ...
      <el-row>
        ...
        >
          ...
          <el-table-column show-overflow-tooltip prop="sendTime" label="发文日期" align="center"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      processInstIdRow:"",
      typeFW: "doneFW",
      state: sessionStorage.getItem('XNKBTABFW')||1,
      page: 1, //当前页数
      limit: 10, //每页条数
      total: 0,
      tableData: []
  ...
  methods: {
    ...
    initData() {
      ...
      postObj.state == '0'?this.typeFW = 'todoFW':this.typeFW='doneFW'
      this.$post
        .postData(
          postObj.function,
