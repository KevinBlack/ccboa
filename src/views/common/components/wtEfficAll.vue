<template>
  <div class="AllWrapper wh100">
    ...
    >
      ...
      <!-- <el-table-column show-overflow-tooltip prop="sendTime" label="办结日期" align="center"></el-table-column> -->
      <el-table-column show-overflow-tooltip :formatter="formatter" prop="tms" label="当前处理人接收时间" align="center"></el-table-column>
      <el-table-column
        show-overflow-tooltip
...
export default {
  ...
  methods: {
    ...
    init(){ //请求列表数据：TODO
      let params = Object.assign(this.postObj,this.baseParams);
         params = Object.assign(params,{curNodeCode:'001'});
