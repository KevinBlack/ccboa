<template>
  <div>
    ...
    <treeCofig  :dialogTit="dialogTit" :hasRadio="hasRadio" :setradio="setradio" :offenUse="offenUse" :checkIds="checkIds" :canTab="canTab" :singelCheckF="singelCheckF" :dialogState="dialogState" @showCompDialog="showCompDialog"></treeCofig>
  </div>
</template>
