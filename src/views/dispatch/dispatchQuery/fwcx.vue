  ...
  <div>
    <el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="规章/规范性文件" prop="isStandardFile" ref="isStandardFile">
                  <el-radio
                    v-model="ruleForm.isStandardFile"
                    label=""
                    class="radio_fst"
                  >全部</el-radio>
                  <el-radio
      ...
      <el-col style="text-align:right;margin-top:10px;">
        <el-button size="small" @click="exportExc">导 出</el-button>
      </el-col>
          ...
          <el-col class="check_area">
            <el-row>
              ...
              <el-checkbox-group v-model="stateList" @change="stateChange">
                ...
                <el-col :span="8"><el-checkbox label="当前环节" value="currentNode"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="当前处理人" value="currentUser"></el-checkbox></el-col>
              </el-checkbox-group>
            </el-row>
          </el-col>
          <el-col class="check_area">
            <el-row>
              ...
              <el-checkbox-group v-model="elementList" @change="elementChange">
                <el-col :span="8" :offset="1"><el-checkbox label="拟稿日期" value="draftTime"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="秘密类型" value="secretType"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="是否直发" value="isDirect"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="发文日期" value="sendTime"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="秘密期限类型" value="secretLimitType"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="直发范围" value="directRange"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="发文字号" value="documentNo"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="秘密标志" value="secretFlagType"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="直发文种类" value="directType"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="标题" value="title"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="密级和保密期限" value="secretFlagContent"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="发文依据" value="sendBasis"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="发文种类" value="sendType"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="知悉范围" value="knowScore"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="规章/规范性文件" value="isStandardFile"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="主办部门" value="draftDepartment"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="定密依据" value="secretGists"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="是否经过消保审查" value="isNeedCheckcp"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="紧急程度" value="emergencyLevel"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="保管期限" value="keepLimit"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="档案利用范围" value="userRange"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="业务分类" value="businessType"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="附件标题" value="attachTitle"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="联合发文单位" value="uniondepartment"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="文种" value="textType"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="半电子" value="isArtificial"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="分别发送" value="isSeparate"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="成文日期" value="completeTime"></el-checkbox></el-col>
              </el-checkbox-group>
            </el-row>
          </el-col>
          <el-col class="check_area">
            <el-row>
              ...
              <el-checkbox-group v-model="objList" @change="objChange">
                <el-col :span="8" :offset="1"><el-checkbox label="会签部门" value="signDepartmentName"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="行外会签" value="outsideSign"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="抄送" value="copy"></el-checkbox></el-col>
                <el-col :span="8" :offset="1"><el-checkbox label="行外发送" value="inline"></el-checkbox></el-col>
                <el-col :span="8"><el-checkbox label="主送" value="main"></el-checkbox></el-col>
                <el-col :span="7"><el-checkbox label="已完成会签部门" value="finishSignDepartmentName"></el-checkbox></el-col>
              </el-checkbox-group>
            </el-row>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
      ...
      this.handleReqAllData().then(status => {
        if (status) {
          ...
          setTimeout(() => {
            // this.exportExc("2");
            //5000千条导出一个table表
            let tableTotal = Math.ceil(this.tableData1.length % 5000);//2
            for(var i = 1; i <= tableTotal; i ++){
              let tableName = "发文查询表(" + (i * 5000 - 4999) + "-" + i * 5000 + ")";
              this.exportExc(tableName,"2");//签报查询表(1-5000)、签报查询表(5001-10000)
            };
          },1000)
        }
      })
    ...
    async handleReqAllData() {
      ...
      await this.$post.postData("searchSendOrderExt", JSON.stringify(Object.assign({},this.bank_select1, this.pagination)), this.$businessCode.fawgl).then(res => {
        if (res.success) {
    ...
    exportExc(name,val){
      ...
      exportTable.exportExcel("发文查询表",".el-table");
    },
    // 下拉列表
    ...
    cellClick(row, column, cell, event){
      ...
      } else if  (row.sendType === '会签') {
        if (row.isFlowEnd == '已办') {
          this.handleOpenPage('/countersignendDone', row.id)
        } else if (row.isFlowEnd == '待办') {
          this.handleOpenPage('/countersignend', row.id, "bd")
        } else if (row.isFlowEnd == '办结') {
          this.handleOpenPage('/countersignendFinishRed', row.id)
        }
      }
    },
