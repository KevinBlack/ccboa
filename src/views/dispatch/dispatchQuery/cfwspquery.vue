<template>
  <div id="app" class="bank_dispach">
    ...
    <header class="bank_dispach_header">
      <h3 class="bank_dispach_tit">中国建设银行发文重发审批单</h3>
    </header>
        ...
        <div class="bank_dispach_file_part">
          ...
          <!-- <fieldset disabled> -->
            ...
            <div>
              <el-row>
                <el-col >
                  <el-form-item label="正文标题" prop="type" ref="type">
                    <el-input></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="文件形式" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="原签发人" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
               <el-col :span="8">
                  <el-form-item label="主办部门" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="申请人" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="联系电话" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="成交日期" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="申请日期" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="重发日期" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="直发范围" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="直发文种类" prop="documentNo" ref="documentNo">
                    <el-input v-model="fromdata.documentNo" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                ...
                <el-col>
                  <el-form-item label="重发会签">
                    <el-input v-model="fromdata.outsideSign" disabled="disabled"></el-input>
                    <el-button slot="append" icon="el-icon-plus" @click="bankmain('hui')"></el-button>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="重发原因">
