              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="业务分类" :span="8" prop="businessType" ref="businessType">
                    <el-select v-model="fromdata.businessType" placeholder="请选择" disabled="disabled" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="文种" :span="8" prop="textType" ref="textType">
                    <el-select v-model="fromdata.textType" disabled="disabled" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  ...
                  >
                    ...
                    >
                      <el-option
                        v-for="secretFlagTypeitem in SworkSecretFlag"
                ...
                <el-col :span="8">
                  ...
                  >
                    ...
                    >
                      <el-option
                        v-for="secretFlagTypeitem in SsecretFlagType"
                        :key="secretFlagTypeitem.label"
                        :label="secretFlagTypeitem.label"
                        :value="secretFlagTypeitem.label"
                      ></el-option>
                ...
                <el-col :span="8">
                  <el-form-item label="主办部门" prop="draftOrgan" ref="draftOrgan">
                    <el-input v-model="fromdata.draftOrgan" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="16">
                  <el-form-item label="联合发文单位">
                    <el-input v-model="fromdata.unionDepartment" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item
                   ...
                   disabled="disabled"
                  >
                    <el-input v-model="fromdata.draftUser" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="联系电话" prop="phone" ref="phone">
                    <el-input v-model="fromdata.phone" maxlength="11" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item
                ...
                <el-col>
                  <el-form-item label="发文依据">
                    <el-input v-model="fromdata.sendBasis" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>

                <el-col :span="8">
                  <el-form-item label="直发文件" prop="isDirect" ref="isDirect">
                    <el-radio v-model="fromdata.isDirect" disabled="disabled" label="是">是</el-radio>
                    <el-radio v-model="fromdata.isDirect" disabled="disabled" label="否">否</el-radio>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="直发范围" :span="8">
                    <el-select v-model="fromdata.directRange" placeholder="请选择" disabled="disabled" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="直发文种类" :span="8">
                    <el-select v-model="fromdata.directType" placeholder="请选择" disabled="disabled" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="档案利用范围" prop="userRange" ref="userRange">
                    <el-radio v-model="fromdata.userRange" disabled="disabled" label="是">是</el-radio>
                    <el-radio v-model="fromdata.userRange" disabled="disabled" label="否">否</el-radio>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="规章/规范性文件" prop="isStandardFile" ref="isStandardFile">
                    <el-radio v-model="fromdata.isStandardFile" disabled="disabled" label="是">是</el-radio>
                    <el-radio v-model="fromdata.isStandardFile" disabled="disabled" label="否">否</el-radio>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="保管期限" prop="keepLimit" ref="keepLimit">
                    <el-select v-model="fromdata.keepLimit" disabled="disabled" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col>
                  <el-form-item label="正文标题" prop="title" ref="title">
                    <el-input v-model="fromdata.title" placeholder="请输入正文标题" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="附件标题">
                    <el-input v-model="fromdata.attachTitle" placeholder="请输入附件标题" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
              ...
              <el-row>
                ...
                <el-col>
                  <el-form-item label="行外会签">
                    <el-input v-model="fromdata.outsideSign" type="textarea" resize="none" autosize disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="主    送" prop="main" ref="main">
                    <el-input v-model="fromdata.main" placeholder="请选择主送部门" disabled="disabled" style="width: 100%;">
                ...
                <el-col>
                  <el-form-item label="抄    送">
                    <el-input v-model="fromdata.copy" placeholder="请选择抄送部门" style="width: 100%;" disabled="disabled">
                ...
                <el-col>
                  <el-form-item label="本行发送">
                    <el-input v-model="fromdata.inline" placeholder="请选择本行发送" style="width: 100%;" disabled="disabled">
              ...
              <el-row>
                <el-col>
                  <el-form-item label="签发意见">
                    <template>
                      <div v-for="item in fromdata.opinionSendList" :key="item.id" class="d_flex">
                        <el-row class="d_b100">
                          <el-col :span="22" class="pos_r">
                            <el-input
                              type="textarea"
                              :value="item.content"
                              disabled="disabled"
                      ...
                      <el-input type="textarea" v-model="fromdata.opinionSend" disabled="disabled"></el-input>
                    </template>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="核稿意见">
                    <div v-for="item in fromdata.opinionCheckList" :key="item.id" class="d_flex">
                      <el-row class="d_b100">
                        <el-col :span="22" class="pos_r">
                          <el-input
                            type="textarea"
                    ...
                    <el-input type="textarea" v-model="fromdata.opinionDraf" disabled="disabled"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="会签意见">
                    <div v-for="(item,n) in fromdata.opinionSignList" :key="item.id" class="d_flex">
                      <el-row class="d_b100">
                        <el-col :span="22" class="pos_r">
                          <el-input
                            type="textarea"
                    ...
                    <el-input type="textarea" disabled="disabled" v-model="fromdata.opinionSign"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="审核意见">
                    ...
                    <div
                      v-for="(item,n) in fromdata.opinionCheckList"
                      :key="item.id"
                      class="d_flex"
                    >
                      <el-row class="d_b100">
                    ...
                    <div style="display:flex">
                      <el-input type="textarea" style="flex:1" disabled="disabled" v-model="fromdata.opinionCheck"></el-input>
                      <button
                        @click="writelistbox(clickTypes=1)"
                        type="button"
                        class="el-button el-button--default dimi_btn"
                ...
                <el-col v-if="false">
                  <el-form-item label="审核意见">
                    <div class="opinionCheck_w">
                      <p class="opinionCheck">{{fromdata.opinionCheck}}</p>
                      <p class="opinionCheckpeo">{{fromdata.opinionCheck}}</p>
                    </div>
                  </el-form-item>
                </el-col>
                ...
                <el-col>
                  <el-form-item label="备    注">
                    <el-input type="textarea"  v-model="fromdata.comments" placeholder="填写备注可输入500字"></el-input>
                  </el-form-item>
                </el-col>
                
                <el-col>
                  <el-form-item label="正文字数">
                    <el-input type="textarea"  v-model="fromdata.comments" ></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="是否半电子" >
                    <el-radio v-model="fromdata.isSeparate" disabled="disabled" label="是">是</el-radio>
                    <el-radio v-model="fromdata.isSeparate" disabled="disabled" label="否">否</el-radio>
                  </el-form-item>
                </el-col>
                <el-col>
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [ { label: "拟稿日期", prop: "createTime", align: "center" },
