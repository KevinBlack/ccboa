        ...
        <el-row>
          <el-col>
            <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm mt20 transition_wrap" :class="{mtdown:down}">
              <el-row>
                <el-col :span="6">
                  <el-form-item label="拟稿日期"  prop="endTime">
                  <div class="block">
                    <el-date-picker
                 ...
                 <el-col :span="6">
                  <el-form-item label="发文日期"  prop="endTime">
                  <div class="block">
                    <el-date-picker
                    @change="timeChange(events)"
                      v-model="ruleForm.endTime"
                ...
                <el-col :span="6">
                  <el-col v-if="!down" class="arrowup">
                    ...
                    <el-button type="primary" @click="submitForm" style="margin-left:20px">导出</el-button>
...
const finshData = [
  { label: "接收日期", prop: "date", align: "center", width: "150px", 
    formatter(row,column){return row.date} 
  },
  { label: "发文字号", prop: "fileId", align: "center", width: "300px" },
...
const otherData = [
  ...
  { label: "发文字号", prop: "fileId", align: "center", width: "300px" },
  { label: "标题", prop: "title", align: "center" },
  { label: "当前环节", prop: "tache", align: "center", width: "150px" },
  { label: "操作人 ", prop: "person", align: "center", width: "150px" }
];
