              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="业务分类" :span="8" prop="businessType" ref="businessType">
                    <el-select v-model="fromdata.businessType" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="文种" :span="8" prop="textType" ref="textType">
                    <el-select v-model="fromdata.textType" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="主办部门" prop="draftOrgan" ref="draftOrgan">
                    <el-input v-model="fromdata.draftOrgan" :disabled="fromdata.state==1"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="16">
                ...
                <el-col>
                  <el-form-item label="发文依据">
                    <el-input v-model="fromdata.sendBasis"></el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="8">
                  <el-form-item label="保管期限" prop="keepLimit" ref="keepLimit">
                    <el-select v-model="fromdata.keepLimit" placeholder="请选择" style="width:100%">
                      <el-option
                ...
                <el-col>
                  <el-form-item label="附件标题">
                    <el-input v-model="fromdata.attachTitle" placeholder="请输入附件标题"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
              ...
              <el-row>
                ...
                <el-col>
                  <el-form-item label="行外会签">
                    <el-input v-model="fromdata.outsideSign" type="textarea" resize="none" autosize></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="主    送" prop="main" ref="main">
                    <el-input v-model="fromdata.main" placeholder="请选择主送部门" style="width: 100%;">
                ...
                <el-col>
                  <el-form-item label="抄    送">
                    <el-input v-model="fromdata.copy" placeholder="请选择抄送部门" style="width: 100%;">
                ...
                <el-col>
                  <el-form-item label="本行发送">
                    <el-input v-model="fromdata.inline" placeholder="请选择本行发送" style="width: 100%;">
                ...
                <el-col>
                  <el-form-item label="签发意见">
                    <template>
                      ...
                      <el-input type="textarea" v-model="fromdata.opinionSend"></el-input>
                    </template>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="核稿意见">
                    ...
                    <el-input type="textarea" v-model="fromdata.opinionDraf"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="会签意见">
                    ...
                    <el-input type="textarea" v-model="fromdata.opinionSign"></el-input>
                  </el-form-item>
                </el-col>
                <el-col>
