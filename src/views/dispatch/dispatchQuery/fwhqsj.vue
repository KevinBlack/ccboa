      ...
      <el-col>
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm transition_wrap" :class="{mtdown:down}">
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="会签日期" prop="draftRangeTime">
                <el-date-picker
            ...
            <el-col :span="6">
              <el-row>
                <el-col :span="21">
                  <el-form-item label="会签部门" prop="draftDepartmentId">
          ...
          <div v-if="down" class="clearfix">
            <el-row>
              <el-form-item label="会签状态" prop="sendType">
                <el-radio-group v-model="ruleForm.signState">
                  <el-radio label="0">全部</el-radio>
                  <el-radio label="1">正在会签</el-radio>
                  <el-radio label="2">会签完毕</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-row>
            <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        { label: "会签部门", prop: "signDepartment", align: "center", width:"120px" },
        ...
        { label: "会签开始时间", prop: "createTime", align: "center", width: "150px" },
        { label: "会签结束时间", prop: "finishTime", align: "center", width: "150px" },
        { label: "会签状态", prop: "isFlowEnd", align: "center", width: "80px" },
        { label: "会签办理时长/日", prop: "disposeDuration", align: "center", width: "110px" }
      ]
    };
  },
  methods: {
    exportExc(){
      exportTable.exportExcel("发文会签办理时间查询表",".el-table");
    },
    /**
     * 列表数据查询
    */
    getTableList(val){
      ...
      this.$post.postData("searchSignHandleTime", JSON.stringify(Object.assign({},this.bank_select, this.pagination)), this.$businessCode.fawgl).then(res => {
