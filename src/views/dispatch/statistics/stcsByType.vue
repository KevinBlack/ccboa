  ...
  <el-row>
    ...
    <el-row class="el-table">
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column label="办结发文数量统计表（按类型统计）" align="center">
            <el-table-column type="index" width="50" label="序号" align="center"></el-table-column>
            <el-table-column prop="typeName" label="发文类型" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handlerSearch () {
      ...
      this.params.function = 'statistOrderType';
      this.$post.postData('statistOrderType', JSON.stringify(this.params),this.$businessCode.fawgl).then((res) => {
        if(res.success){
