  ...
  <el-row>
    ...
    <el-row class="el-table">
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column label="部门公文重发文数量统计表" align="center">
            <el-table-column type="index" width="50" label="序号" align="center"></el-table-column>
            <el-table-column prop="unitName" label="拟稿部门" align="center"></el-table-column>
            <el-table-column prop="fwCs" label="发文次数" align="center"></el-table-column>
            <el-table-column label="重发" align="center">
              <el-table-column label="次数" prop="cfCs" align="center"></el-table-column>
              <el-table-column label="件数" prop="cfJs" align="center"></el-table-column>
              <el-table-column label="重发率" prop="cfl" align="center"></el-table-column>
            </el-table-column>
          </el-table-column>
        </el-table>
        <!-- <el-pagination
...
export default {
  ...
  methods: {
    ...
    handlerSearch () {
      ...
      this.params.function = 'statistDeptAgain';
      this.$post.postData('statistDeptAgain', JSON.stringify(this.params),this.$businessCode.fawgl).then((res) => {
        if(res.success){
    ...
    exportExc(){
      exportTable.exportExcel("部门公文重发文数量统计表",".el-table");
    },
  },
  created () {
