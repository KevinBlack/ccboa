  ...
  <el-row>
    ...
    <el-row class="el-table">
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column label="发文会签时间统计表" align="center">
            <el-table-column type="index" width="50" label="序号" align="center"></el-table-column>
            <el-table-column prop="unitName" label="会签部门" align="center"></el-table-column>
            <el-table-column prop="cou" label="会签件数" align="center"></el-table-column>
            <el-table-column prop="avgt" label="平均会签时间" align="center"></el-table-column>
            <el-table-column prop="maxt" label="最长会签时间" align="center"></el-table-column>
          </el-table-column>
        </el-table>
        <!-- <el-pagination
...
export default {
  ...
  methods: {
    ...
    handlerSearch () {
      ...
      this.params.function = 'statistDeptSign';
      this.$post.postData('statistDeptSign', JSON.stringify(this.params),this.$businessCode.fawgl).then((res) => {
        if(res.success){
    ...
    exportExc(){
      exportTable.exportExcel("发文会签时间统计表",".el-table");
    }
  },
  created() {
