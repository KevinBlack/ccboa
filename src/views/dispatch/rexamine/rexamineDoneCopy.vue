    ...
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="handleFile" v-show="isRecentTowYear&&bank_selectConfig.curNodeId=='800'">归档</el-button>
          <el-button size="small" plain @click="handleFileNew" v-show="bank_selectConfig.curNodeId == '800'">区块链归档</el-button>
                      ...
                      <div v-for="(item, index) in  fromdata.attchmentFileInfo" :key="index" class="comp_list">  
                        <template>
                          <div class="command_file">
                            ...
                            <span class="down" :title="item.fileName"
                            @click="viewDraftFile(item.fileName,item.filePath ,$businessCode.fawglfj)">{{item.fileName}}</span>
