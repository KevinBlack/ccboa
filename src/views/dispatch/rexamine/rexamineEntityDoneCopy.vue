<template>
  <div id="rexamineEntityDone" class="bank_dispach">
    <el-row>
      ...
      <div class="bank_dispach_file">
        <div class="bank_dispach_file_part">
          ...
          >
              ...
              <el-row>
                ...
                <el-col :span="24">
                  <el-form-item label="会签部门" prop="signDepartment" ref="signDepartment">
                    <el-input v-model="fromdata.signDepartment" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
              ...
              <el-row>
                <el-col>
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-input  v-model="fromdata.finishNewSignDepartmentName" placeholder="已完成的会签部门" disabled></el-input>
                    </el-col>
                  </el-row>
                </el-col>
                <el-col>
              ...
              <el-row>
                <el-col>
                  <el-form-item label="签发意见">
                    <template>
                      <!-- <div v-for="(item,index) in fromdata.opinionSendList" :key="item.id" class="d_flex">
                        <el-row class="d_b100">
                          <el-col :span="22"  :class="['pos_r',{'disable_w':item.createTime !=fromdata.opinionMaxTime}]">
                            <el-input
                      ...
                      <el-input type="textarea" resize="none" autosize v-model="fromdata.opinionSendId" disabled></el-input>
                    </template>
                  </el-form-item>
                </el-col>
                <el-col>
            ...
            <!-- 附件 -->
            <h6 class="bank_dispach_file_tit mrg-b-20">附件</h6>
...
export default {
  ...
  methods: {
      ...
      this.loadingTree = true;
          this.$post
            ...
            .then(res => {
              ...
              that.fromdata.wfeUnitId = UnitId = that.unitId
    ...
    async maintenance(){
      let data={
        ...
        let obj2=await this.$post.postData(
            "getAgainOrderOpintions",
            JSON.stringify(Object.assign(data,{function :"getAgainOrderOpintions"})),this.$businessCode.fawgl
          ).then(res => {
            return res.data;
          })
          .catch(err => {
    ...
    completeSending() {
      ...
      this.$post.postData("getNextNodeInfo", JSON.stringify(this.bank_selectConfig), this.$businessCode.fawgl).then(res => {
        ...
        this.bank_send.wfeUnitId = this.unitId
  ...
  created() {
    ...
    this.uploadConfig.flowTranId = this.$businessCode.fawglfj;
    this.toEditAgainOrder();
