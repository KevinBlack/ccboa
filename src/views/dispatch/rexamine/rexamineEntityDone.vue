              ...
              <el-row>
                ...
                <el-col :span="24">
                  ...
                  <el-form-item v-if="showNweAttachTitle" label="修改后标题" prop="newAttachTitle">
                    <el-input v-model="fromdata.newAttachTitle" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  ...
                  <el-row>
                    ...
                    <el-col :offset="1" :span="8">
                      <el-form-item prop="finishNewSignDepartmentName" ref="finishNewSignDepartmentName">
                        <el-input v-model="fromdata.finishNewSignDepartmentName" placeholder="已完成的会签部门" style="width: 100%;" @input="inputChange" disabled></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                </el-col>
