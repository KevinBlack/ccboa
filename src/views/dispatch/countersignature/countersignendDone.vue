<template>
  <div id="countersignendDone" class="bank_dispach">
    <el-row>
                    ...
                    <template>
                      ...
                      <div class="fix_height">
                        <el-input
                          ...
                          v-if="(!(fromdata.processOpinionList && fromdata.processOpinionList.length!==0))||fromdata.isMutil != 1"
                          disabled
                        ></el-input>
                      </div>
                      <opinionText 
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="分别发送">
                    <el-radio v-model="fromdata.isSeparate" label="是" disabled>是</el-radio>
                    <el-radio v-model="fromdata.isSeparate" label="否" disabled>否</el-radio>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="半电子">
                    <el-radio v-model="fromdata.isArtificial" label="是" disabled>是</el-radio>
                    <el-radio v-model="fromdata.isArtificial" label="否" disabled>否</el-radio>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
  ...
  methods: {
    ...
    deleteRow(n,id) {
      this.bank_deleteFileById.id = id;
       this.$post
        .postData("deleteFileById", JSON.stringify(this.bank_deleteFileById), this.$businessCode.fawglfjs)
        .then(res => {
          console.log(res);
          if (res) {
              if (res && res.success) {
