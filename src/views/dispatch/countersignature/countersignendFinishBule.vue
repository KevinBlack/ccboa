<template>
  <div id="countersignendFinishBule" class="bank_dispach">
    <el-row>
                  ...
                  <el-form-item label="会签意见" prop="opinionSign" ref="opinionSign">
                    ...
                    <div style="display:flex">
                      <el-input
                        ...
                        v-if="fromdata.opinionSignId||!(fromdata.opinionSignList && fromdata.opinionSignList.length!=0)"
                        disabled
                        maxlength="500"
                      ></el-input>
                      <!-- <button
                ...
                <el-col>
                  <el-form-item label="最终意见">
                    <template>
                      ...
                      <el-input type="textarea" resize="none" autosize v-model="fromdata.finalOpinion"></el-input>
                    </template>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="过程意见">
                    <template>
                      ...
                      <el-input type="textarea" resize="none" autosize v-model="fromdata.processOpinion"></el-input>
                    </template>
                  </el-form-item>
                </el-col>
              </el-row>
