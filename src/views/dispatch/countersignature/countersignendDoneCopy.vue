    ...
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button plain size="small" @click="maintenance">维护</el-button>
          <el-button size="small" plain v-show="bank_selectConfig.curNodeId != '800'&&fromdata.isShowSendXb != 1&&fromdata.isShowLC!=1" @click="processScheduling">流程调度</el-button>
          ...
          <el-button size="small" plain @click="collect('sign', bank_dispach.id, unitId)">收藏</el-button>
          <!-- <el-button plain size="small" @click="handleShowRegain" v-if="fromdata.currentNodeId!=800&&readFlag !=1 &&allowBack==true">收回</el-button>
...
export default {
  ...
  methods: {
    ...
    async maintenance(){
      let data={
        ...
        let obj2=await this.$post.postData(
            "getSignOrderOpintions",
            JSON.stringify(Object.assign(data,{function :"getSignOrderOpintions"})),this.$businessCode.fawgl
          ).then(res => {
            return res.data;
          })
          .catch(err => {
        ...
        let obj3=await this.$post.postData(
            "getSendAttachmentPo",
            JSON.stringify(Object.assign(data,{function :"getSendAttachmentPo", dataId:this.fromdata.sendOrderId})),this.$businessCode.fawgl
          ).then(res => {
            return res.data;
          })
          .catch(err => {
    ...
    toEdit() {
      let that = this;
      that.bank_dispach.unitId = this.unitId;
    ...
    getTcDocTypeDicByParam() {
      this.bank_redheader = this.unitId;
      this.$post
        .postData(
          "getTcDocTypeDicByParam",
    ...
    doDraft(fileInfo){
      let data = this.$router.resolve({
        ...
        query: {
          ...
          unitId:this.unitId,
          flowTranId:this.$businessCode.fawgl //流程交易线
        }
      });
