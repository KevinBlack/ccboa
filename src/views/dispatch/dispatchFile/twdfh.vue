    ...
    <el-row>
      <el-col class="bank_dispack_side">
        ...
        <div class="grid_comtent">
          ...
          <el-button size="small" plain @click="selectBackInfoListBySendOrderId">退回说明</el-button>
...
export default {
  ...
  methods: {
    ...
    selectBackInfoListBySendOrderId() {
      ...
      this.bank_selectBackInfoListBySendOrderId.id = this.fromdata.sendOrderId;
      this.bank_selectBackInfoListBySendOrderId.unitId = this.unitId;
      this.$post
        .postData(
          "selectBackInfoListBySendOrderId",
      ...
      this.$post
        ...
        .then(res => {
          ...
          if(res.data.isSpecialHead && res.data.isSpecialHead == '1') {
            that.draftOrganTitle = res.data && res.data.draftDepartment + "电子发文流转退文单";
          } else {
            that.draftOrganTitle = res.data && res.data.draftOrgan + "电子发文流转退文单";
          }
          ...
          that.fromdata.sendBasis = JSON.parse(res.data.sendBasis)
    ...
    flowScheme() {
      ...
      this.bank_cklc.createTime = this.fromdata.createTime;
