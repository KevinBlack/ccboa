    ...
    <el-row>
          ...
          <el-row>
            <el-col :span = "8">
              <!-- <el-form-item label="行名" prop="queryUnit">
                <el-select v-model="ruleForm.queryUnit"
                  @change="change($event)"
      ...
      <el-col :span="24" style="padding:20px;">
        <table class="stcs_table">
          ...
          <tr>
            ...
            <td>表头:{{queryUnitName}}<span v-if="ruleForm.sendDeptId.length<20">{{ruleForm.sendDeptId}}</span><span v-if="ruleForm.sendDeptId.length>20">全部</span><span v-if="queryUnitName || ruleForm.sendDeptId">公文问与答明细表</span></td>
      ...
      <el-col style="margin: 20px 0;">
        ...
        <el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
          ...
          <el-table-column prop="receiveWenhao" label="文号"></el-table-column>
          <el-table-column width="180px" prop="documentTitle" label="标题"></el-table-column>
          <el-table-column prop="draftUserName" label="拟稿人"></el-table-column>
          <el-table-column prop="questionCount" label="提问数"></el-table-column>
          <el-table-column prop="answerCount" label="回答数"></el-table-column>
          <el-table-column prop="answerPercent" label="回答率"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    selectOrg(org) {
      ...
      console.log(this.unitName,this.unitId,"qqqqq112");
    },
    change(e){
      console.log(e)
    ...
    getTreeData(n) {
      ...
      //this.deptIdData.deptId=this.
      console.log(this.ruleForm.deptId,this.unitId,"9999");
      ...
      this.dialogTit = name;
      this.showCompDialog();
       obj.unitCode=this.deptIdData.unitCode=this.ruleForm.deptId;
       console.log(this.ruleForm.deptId,this.unitId,"009");
      this.$post
        .postData(
          "unitTreeByFirst",
          JSON.stringify(obj),
      ...
      if(this.times=="") {
        ...
        this.$post
          ...
          .then(res => {
            ...
            newData.push({
              receiveWenhao:"合计",
              documentTitle:"文件共"+res.total+"份",
              //answerUserName:res.totalPercent,
              questionCount:res.totalQuestion,
              answerCount:res.totalAnswer,
              answerPercent:res.totalPercent,
            })
