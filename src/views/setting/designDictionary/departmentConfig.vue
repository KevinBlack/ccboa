<!--nwl
 * @Date: 2020-08-05 18:32:40
 * @LastEditTime: 2020-08-05 18:31:45
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \ccboa\src\views\setting\designDictionary\departmentConfig.vue
-->
<template>
  <div class="content">
    <p class="base-title">部门配置</p>
    <div class="btn-list">
...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        { label: "部门类别text", prop: "deptTypeId" },
        { label: "部门类别value", prop: "deptTypeName" },
      ],
      tableData: [],
      pagination: {
        pageNum: 1,
  ...
  methods: {
    ...
    editordata() {
      this.$api.designDictionary
        .updateDeptList({ deptConfigs: this.tableData })
        .then((res) => {
          this.$message({
            type: "success",
            message: "保存成功",
    ...
    btnAdd() {
      this.$refs.fdForm.submit().then((res) => {
        ...
        this.formData1 = { deptTypeId: "", deptTypeName: "" };
