      ...
      <el-col>
        ...
        >
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="承办部门" prop="mainOrganNames">
...
export default {
  ...
  data() {
    return {
      bank_countersignature: {
        function: "detailsReceiveUndertakeQs"
      },
      pickerOptions: {
        shortcuts: [
          {
      ...
      tableData: [],
      tableCols: [
        { label: "发承办时间", prop: "startTime", align: "center", width: "150px" },
        ...
        { label: "承办部门", prop: "deptName", align: "center", width: "80px" },
  ...
  methods: {
    // 页面初始化加载数据
    handleLoadData() {
      this.$post.postData('detailsReceiveUndertakeQs', JSON.stringify(Object.assign(this.bank_countersignature, this.ruleForm, this.pagination)), this.$businessCode.xnkb).then((res) => {
