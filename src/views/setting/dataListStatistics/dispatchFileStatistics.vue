      ...
      <el-col>
        ...
        >
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="拟稿部门" prop="mainOrganNames">
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      tableCols: [
        { label: "拟稿时间", prop: "draftTime", align: "center", width: "150px" },
        { label: "标题", prop: "title", align: "left", minwidth:"40%" },
        { label: "文号", prop: "documentNo", align: "center", width: "220px" },
        { label: "拟稿部门", prop: "draftDept", align: "center", width: "220px" },
        { label: "发文类型", prop: "TYPE", align: "center" },
        { label: "办理时长（天）", prop: "rownum_", align: "center", width: "220px" },
  ...
  methods: {
    // 页面初始化加载数据
    handleLoadData() {
      this.$post.postData('detailsSendOrder', JSON.stringify(Object.assign(this.bank_countersignature, this.ruleForm, this.pagination)), this.$businessCode.xnkb).then((res) => {
