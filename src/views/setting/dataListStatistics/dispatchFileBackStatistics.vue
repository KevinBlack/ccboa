...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: "退文部门", prop: "backDept", align: "center" },
        { label: "发文时间", prop: "sendTime", align: "center", width: "150px" },
  ...
  methods: {
    // 页面初始化加载数据
    handleLoadData() {
      this.$post.postData('detailsBackOrder', JSON.stringify(Object.assign(this.bank_countersignature, this.ruleForm, this.pagination)), this.$businessCode.xnkb).then((res) => {
