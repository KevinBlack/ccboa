...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: "重发时间", prop: "sendTime", align: "center", width: "150px" },
  ...
  methods: {
    // 页面初始化加载数据
    handleLoadData() {
      this.$post.postData('detailsAgainOrder', JSON.stringify(Object.assign(this.bank_countersignature, this.ruleForm, this.pagination)), this.$businessCode.xnkb).then((res) => {
